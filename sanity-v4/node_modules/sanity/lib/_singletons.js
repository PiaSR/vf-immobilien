...
const ActiveWorkspaceMatcherContext = _createContext.createContext("sanity/_singletons/context/active-workspace-matcher", null), AddonDatasetContext = _createContext.createContext("sanity/_singletons/context/addon-dataset", null), AppIdCacheContext = _createContext.createContext("sanity/_singletons/context/app-id-cache", null), AssetLimitUpsellContext = _createContext.createContext("sanity/_singletons/context/asset-limit-upsell", null), CalendarContext = _createContext.createContext("sanity/_singletons/context/calendar", void 0), ChangeIndicatorTrackerContextStore = _createContext.createContext("sanity/_singletons/context/change-indicator-tracker-store", null), ChangeIndicatorTrackerContextGetSnapshot = _createContext.createContext("sanity/_singletons/context/change-indicator-tracker-get-snapshot", null), ColorSchemeSetValueContext = _createContext.createContext("sanity/_singletons/context/color-scheme-set-value", null), ColorSchemeValueContext = _createContext.createContext("sanity/_singletons/context/color-scheme-value", null), CommentInputContext = _createContext.createContext("sanity/_singletons/context/comment-input", null), CommentsAuthoringPathContext = _createContext.createContext("sanity/_singletons/context/comments-authoring-path", null), CommentsContext = _createContext.createContext("sanity/_singletons/context/comments", null), CommentsEnabledContext = _createContext.createContext("sanity/_singletons/context/comments-enabled", {
...
}), FormBuilderContext = _createContext.createContext("sanity/_singletons/context/form-builder", null), FormCallbacksContext = _createContext.createContext("sanity/_singletons/context/form-callbacks", null), FormFieldPresenceContext = _createContext.createContext("sanity/_singletons/context/form-field-presence", []), FormValueContext = _createContext.createContext("sanity/_singletons/context/form-value", null), FreeTrialContext = _createContext.createContext("sanity/_singletons/context/free-trial", void 0), FullscreenPTEContext = _createContext.createContext("sanity/_singletons/context/fullscreen-pte", {
  getFullscreenPath: () => {
  },
  setFullscreenPath: () => {
  },
  hasAnyFullscreen: () => !1,
  allFullscreenPaths: []
}), GetFormValueContext = _createContext.createContext("sanity/_singletons/context/get-form-value", null), HoveredFieldContext = _createContext.createContext("sanity/_singletons/context/hovered-field", {
  store: {
    subscribe: () => () => {
    },
    getSnapshot: () => []
...
}, ScheduledPublishingEnabledContext = _createContext.createContext("sanity/_singletons/context/scheduled-publishing-enabled", DEFAULT$1), SchedulePublishUpsellContext = _createContext.createContext("sanity/_singletons/context/schedule-publish-upsell", {
  upsellData: null,
...
}), SchedulesContext = _createContext.createContext("sanity/_singletons/context/schedules", void 0), ScrollContext = _createContext.createContext("sanity/_singletons/context/scroll", null), SearchContext = _createContext.createContext("sanity/_singletons/context/search", void 0), SingleDocReleaseContext = _createContext.createContext("sanity/_singletons/context/single-doc-release-context", null), DEFAULT = {
  enabled: !1,
  mode: null
}, SingleDocReleaseEnabledContext = _createContext.createContext("sanity/_singletons/context/single-doc-release-enabled", DEFAULT), SingleDocReleaseUpsellContext = _createContext.createContext("sanity/_singletons/context/single-doc-release-upsell", {
  upsellData: null,
  handleOpenDialog: () => null,
  handleClose: () => null,
  upsellDialogOpen: !1,
...
}), SortableItemIdContext = _createContext.createContext("sanity/_singletons/context/sortable-item-id", null), SourceContext = _createContext.createContext("sanity/_singletons/context/source", null), StructureToolContext = _createContext.createContext("sanity/_singletons/context/structure-tool", null), StudioAnnouncementContext = _createContext.createContext("sanity/_singletons/context/studioAnnouncements", void 0), TasksContext = _createContext.createContext("sanity/_singletons/context/tasks", null), TasksEnabledContext = _createContext.createContext("sanity/_singletons/context/tasks-enabled", {
  enabled: !1,
  mode: null
}), TasksNavigationContext = _createContext.createContext("sanity/_singletons/context/tasks-navigation", null), TasksUpsellContext = _createContext.createContext("sanity/_singletons/context/tasks-upsell", null), UserColorManagerContext = _createContext.createContext("sanity/_singletons/context/user-color-manager", null), ValidationContext = _createContext.createContext("sanity/_singletons/context/validation", []), VirtualizerScrollInstanceContext = _createContext.createContext("sanity/_singletons/context/virtualizer-scroll-instance", null), WorkspaceContext = _createContext.createContext("sanity/_singletons/context/workspace", null), WorkspacesContext = _createContext.createContext("sanity/_singletons/context/workspaces", null), zIndexContextDefaults = {
  navbar: 200,
  navbarPopover: 5e5,
  navbarDialog: 500001,
  // pane
...
exports.AssetLimitUpsellContext = AssetLimitUpsellContext;
...
exports.EnhancedObjectDialogContext = EnhancedObjectDialogContext;
...
exports.FullscreenPTEContext = FullscreenPTEContext;
...
exports.SingleDocReleaseContext = SingleDocReleaseContext;
exports.SingleDocReleaseEnabledContext = SingleDocReleaseEnabledContext;
exports.SingleDocReleaseUpsellContext = SingleDocReleaseUpsellContext;
