...
`, Button = forwardRef(function(t0, ref) {
  ...
  let t4;
  $[7] !== mode || $[8] !== paddingY || $[9] !== ref || $[10] !== rest || $[11] !== sizeProps || $[12] !== tone ? (t4 = /* @__PURE__ */ jsx(Button$1, { ...rest, ...sizeProps, paddingY, ref, mode, tone }), $[7] = mode, $[8] = paddingY, $[9] = ref, $[10] = rest, $[11] = sizeProps, $[12] = tone, $[13] = t4) : t4 = $[13];
  const children = t4;
  if (tooltipProps) {
    const t5 = tooltipProps?.content;
    let t6;
    $[14] !== children ? (t6 = /* @__PURE__ */ jsx(TooltipButtonWrapper, { children }), $[14] = children, $[15] = t6) : t6 = $[15];
    let t7;
    return $[16] !== t5 || $[17] !== t6 || $[18] !== tooltipProps ? (t7 = /* @__PURE__ */ jsx(Tooltip, { content: t5, portal: !0, ...tooltipProps, children: t6 }), $[16] = t5, $[17] = t6, $[18] = tooltipProps, $[19] = t7) : t7 = $[19], t7;
  }
  return children;
