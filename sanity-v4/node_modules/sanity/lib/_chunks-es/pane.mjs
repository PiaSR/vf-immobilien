...
import { useEffect, forwardRef, useRef, useState, useContext, useImperativeHandle, useLayoutEffect, useId, memo, useDeferredValue, lazy, Suspense, startTransition, useCallback, useMemo, useReducer, Fragment as Fragment$1 } from "react";
import { ReviewChangesContext, CommentsEnabledContext, ReferenceInputOptionsContext, PaneLayoutContext, PaneContext, DocumentPaneContext, StructureToolContext, PaneRouterContext, EventsContext, DocumentSheetListContext, DocumentChangeContext } from "sanity/_singletons";
import { TransferIcon, CloseIcon, LockIcon, CheckmarkIcon, UnknownIcon, SearchIcon, DocumentRemoveIcon, ReadOnlyIcon, ErrorOutlineIcon, SyncIcon, WarningOutlineIcon, InfoOutlineIcon, ComposeSparklesIcon, LaunchIcon, UnpublishIcon, StarFilledIcon, StarIcon, ArrowLeftIcon, TrashIcon, ResetIcon, CopyIcon, RevertIcon, PublishIcon, SplitVerticalIcon, EditIcon, AddIcon, ChevronLeftIcon, ChevronDownIcon, RestoreIcon, LinkIcon, EarthAmericasIcon, JsonIcon, DocumentsIcon, ChevronRightIcon, DocumentIcon, FolderIcon, SpinnerIcon, EllipsisHorizontalIcon, DoubleChevronLeftIcon, DoubleChevronRightIcon, CheckmarkCircleIcon, MasterDetailIcon } from "@sanity/icons";
import { isPublishedId, isDraftId, getReleaseIdFromReleaseDocumentId, getVersionFromId, useTranslation, useDocumentVersions, useActiveReleases, getPublishedId, useEditState, useWorkspace, isReleaseDocument, getReleaseTone, isReleaseScheduledOrScheduling, ReleaseAvatar, formatRelativeLocalePublishDate, getDraftId, getVersionId, useMiddlewareComponents, ChangeIndicatorsTracker, VirtualizerScrollInstanceProvider, useDocumentForm, LoadingBlock, FormBuilder, isVersionId, createPatchChannel, LegacyLayerProvider, IsLastPaneProvider, useGetI18nText, useI18nText, TooltipOfDisabled, ContextMenuButton, StatusButton, isDev, CommentsEnabledProvider, useCommentsEnabled, usePerspective, CommentsProvider, COMMENTS_INSPECTOR_NAME, useUnique, isPublishedPerspective, prepareForPreview, unstable_useValuePreview, useDocumentOperationEvent, useDocumentLimitsUpsellContext, isDocumentLimitError, Translate, isNewDocument, Resizable, useKeyValueStore, isRecord, isString, isDraftPerspective, useDocumentOperation, isDeprecatedSchemaType, useProjectId, useClient, useZIndex, useCurrentUser, useListFormat, useDocumentPreviewStore, useArchivedReleases, isCardinalityOneRelease, getVersionInlineBadge, useCanvasCompanionDoc, useNavigateToCanvasDoc, getDocumentVariantType, isPerspectiveWriteable, ReleasesNav, useSanityCreateConfig, getSanityCreateLinkMetadata, LATEST, useVersionOperations, useConditionalToast, useOnlyHasVersions, useSetPerspective, VersionInlineBadge, isGoingToUnpublish, useDocumentStore, useDocumentPresence, PresenceOverlay, fromMutationPatches, useManageFavorite, useActiveWorkspace, CapabilityGate, ScrollContainer, isSanityCreateLinked, useFilteredReleases, isSystemBundle, useDocumentPairPermissions, InsufficientPermissionsMessage, useValidationStatus, useSyncState, useRelativeTime, useSource, Hotkeys, isSanityDefinedAction, useDateTimeFormat, useSchema, useGetDefaultPerspective, useSingleDocRelease, VersionChip, useFieldActions, UserAvatar, useUser, AvatarSkeleton, CommandList, TextWithTone, useTimelineSelector, useEvents, TIMELINE_ITEM_I18N_KEY_MAPPING as TIMELINE_ITEM_I18N_KEY_MAPPING$1, resizeObserver, ChangeConnectorRoot, useGlobalCopyPasteElementHandler, useDocumentIdStack, GetFormValueProvider, FieldActionsResolver, FieldActionsProvider, useHistoryStore, useTimelineStore, useTemplates, useInitialValue, useCopyPaste, useStudioUrl, EMPTY_ARRAY as EMPTY_ARRAY$2, selectUpstreamVersion, pathToString, useEventsStore, EventsProvider, isDeleteDocumentGroupEvent, isDeleteDocumentVersionEvent, PerspectiveProvider, SingleDocReleaseProvider, SourceProvider, CopyPasteProvider, useDocumentType, useTemplatePermissions, ReferenceInputOptionsProvider, useDocumentVersionInfo, getPreviewStateObservable, getPreviewValueWithFallback, SanityDefaultPreview, DocumentPreviewPresence, DocumentStatusIndicator, DocumentStatus, PreviewCard, createHookFromObservableFactory, DEFAULT_STUDIO_CLIENT_OPTIONS, EMPTY_OBJECT, GetHookCollectionState, ErrorActions, collate, createSWR, getSearchableTypes, createSearch, useSearchMaxFieldDepth, catchWithCount, useReconnectingToast, useSearchState, SearchHeader, Filters, SearchProvider, ChangeFieldWrapper, NoChanges, ChangeList, isUnpublishDocumentEvent, isScheduleDocumentVersionEvent, isUnscheduleDocumentVersionEvent, Event, RELEASES_INTENT, isCreateDocumentVersionEvent, isEditDocumentVersionEvent, isPublishDocumentVersionEvent, ChangesError, isArray, isValidationError, isValidationWarning, definePlugin } from "sanity";
...
`, CANVAS_IMAGE_URL = "https://cdn.sanity.io/images/pyrmmpch/production/b47224e2f3a7d1747e43b9da1ac31739250e628b-632x376.png", CANVAS_APP_NAME = "Canvas", CanvasPopoverContent = (t0) => {
  ...
  let t2;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => setOpen(_temp$x), $[6] = t2) : t2 = $[6];
...
const DISABLED_REASON_KEY$2 = {
  ...
  const handle = t4;
  let t5;
  $[10] !== handleConfirm || $[11] !== isConfirmDialogOpen || $[12] !== onComplete || $[13] !== t ? (t5 = isConfirmDialogOpen && {
    type: "confirm",
    tone: "critical",
    onCancel: onComplete,
    onConfirm: handleConfirm,
    message: t("action.discard-changes.confirm-dialog.confirm-discard-changes")
  }, $[10] = handleConfirm, $[11] = isConfirmDialogOpen, $[12] = onComplete, $[13] = t, $[14] = t5) : t5 = $[14];
  const dialog = t5;
  let t6;
  $[15] !== currentUser || $[16] !== dialog || $[17] !== discardChanges.disabled || $[18] !== isPermissionsLoading || $[19] !== isPublished || $[20] !== liveEdit || $[21] !== permissions?.granted || $[22] !== published || $[23] !== t ? (t6 = () => !published || liveEdit || isPublished ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: !0,
    ...
    onHandle: handle,
    dialog
  }, $[15] = currentUser, $[16] = dialog, $[17] = discardChanges.disabled, $[18] = isPermissionsLoading, $[19] = isPublished, $[20] = liveEdit, $[21] = permissions?.granted, $[22] = published, $[23] = t, $[24] = t6) : t6 = $[24];
  let t7;
...
const DISABLED_REASON_KEY$1 = {
  ...
  let t2;
  $[4] !== documentStore.pair || $[5] !== duplicate || $[6] !== id || $[7] !== mapDocument || $[8] !== navigateIntent || $[9] !== onComplete || $[10] !== type ? (t2 = async () => {
    const dupeId = uuid();
    setDuplicating(!0);
  ...
  }, $[4] = documentStore.pair, $[5] = duplicate, $[6] = id, $[7] = mapDocument, $[8] = navigateIntent, $[9] = onComplete, $[10] = type, $[11] = t2) : t2 = $[11];
  const handle = t2;
  let t3;
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      let t42;
      $[12] !== t ? (t42 = t("action.duplicate.label"), $[12] = t, $[13] = t42) : t42 = $[13];
      let t52;
      $[14] !== currentUser ? (t52 = /* @__PURE__ */ jsx(InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[14] = currentUser, $[15] = t52) : t52 = $[15];
      let t62;
      $[16] !== t42 || $[17] !== t52 ? (t62 = {
        icon: CopyIcon,
        disabled: !0,
    ...
    let t5;
    $[19] !== isDuplicating || $[20] !== t ? (t5 = t(isDuplicating ? "action.duplicate.running.label" : "action.duplicate.label"), $[19] = isDuplicating, $[20] = t, $[21] = t5) : t5 = $[21];
    let t6;
    $[22] !== duplicate.disabled || $[23] !== t ? (t6 = duplicate.disabled ? t(DISABLED_REASON_KEY$1[duplicate.disabled]) : "", $[22] = duplicate.disabled, $[23] = t, $[24] = t6) : t6 = $[24];
    let t7;
...
const DISABLED_REASON_KEY = {
  ...
  bb0: {
    if (isConfirmDialogOpen) {
      ...
      let t62;
      $[8] !== handleCancel || $[9] !== handleConfirm || $[10] !== t52 || $[11] !== type ? (t62 = /* @__PURE__ */ jsx(ConfirmDeleteDialogContainer, { id: t52, type, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm }), $[8] = handleCancel, $[9] = handleConfirm, $[10] = t52, $[11] = type, $[12] = t62) : t62 = $[12];
      let t7;
  ...
  const dialog = t4;
  let t5;
  $[16] !== currentUser || $[17] !== dialog || $[18] !== isDraft || $[19] !== isPermissionsLoading || $[20] !== liveEdit || $[21] !== permissions?.granted || $[22] !== release || $[23] !== t || $[24] !== unpublish.disabled ? (t5 = () => release || isDraft || liveEdit ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    icon: UnpublishIcon,
    label: "Unpublish",
    ...
    dialog
  }, $[16] = currentUser, $[17] = dialog, $[18] = isDraft, $[19] = isPermissionsLoading, $[20] = liveEdit, $[21] = permissions?.granted, $[22] = release, $[23] = t, $[24] = unpublish.disabled, $[25] = t5) : t5 = $[25];
  let t6;
...
const DocumentStatusBarActionsInner = memo(function(props) {
  ...
  if (actions.length === 0 || !actionProps)
    return null;
  let t4;
  return $[10] !== actionProps || $[11] !== actions || $[12] !== renderDocumentStatusBarActions ? (t4 = /* @__PURE__ */ jsx(RenderActionCollectionState, { actions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[10] = actionProps, $[11] = actions, $[12] = renderDocumentStatusBarActions, $[13] = t4) : t4 = $[13], t4;
  ...
  if (!actionProps)
    return null;
  let t4;
  return $[12] !== actionProps || $[13] !== historyActions || $[14] !== renderDocumentStatusBarActions ? (t4 = /* @__PURE__ */ jsx(RenderActionCollectionState, { actions: historyActions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[12] = actionProps, $[13] = historyActions, $[14] = renderDocumentStatusBarActions, $[15] = t4) : t4 = $[15], t4;
});
...
const TooltipContent$1 = (t0) => {
  ...
  let t20;
  $[73] !== displayed?._id || $[74] !== documentType || $[75] !== filteredReleases.inCreation || $[76] !== filteredReleases.notCurrentReleases || $[77] !== handleCopyToDraftsNavigate || $[78] !== loading || $[79] !== t ? (t20 = filteredReleases.inCreation && /* @__PURE__ */ jsx(VersionChip, { tooltipContent: /* @__PURE__ */ jsx(TooltipContent$1, { release: filteredReleases.inCreation }), selected: !0, onClick: _temp$s, locked: !1, tone: getReleaseTone(filteredReleases.inCreation), text: filteredReleases.inCreation.metadata.title || t("release.placeholder-untitled-release"), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
    disabled: !0,
...
const HorizontalScroller = styled(Card)((props) => {
  ...
  } = useFieldActions(), [referenceElement, setReferenceElement] = useState(null), scrollContainerRef = useRef(null), showGradient = useChipScrollPosition(scrollContainerRef);
  let t0;
  $[0] !== allActions ? (t0 = allActions ?? [], $[0] = allActions, $[1] = t0) : t0 = $[1];
  let t1;
  ...
  let t5;
  $[13] !== contextMenuNodes || $[14] !== referenceElement ? (t5 = (t62) => {
    const {
      states
    } = t62;
    return /* @__PURE__ */ jsx(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states });
  }, $[13] = contextMenuNodes, $[14] = referenceElement, $[15] = t5) : t5 = $[15];
  const renderPaneActions = t5;
  let t6;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t6 = /* @__PURE__ */ jsx(DocumentHeaderTitle, {}), $[16] = t6) : t6 = $[16];
  const title = t6;
  let t7;
  $[17] !== BackLink2 || $[18] !== showBackButton || $[19] !== t ? (t7 = showBackButton && /* @__PURE__ */ jsx(Button$1, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t("pane-header.back-button.text")
  } }), $[17] = BackLink2, $[18] = showBackButton, $[19] = t, $[20] = t7) : t7 = $[20];
  const backButton = t7;
  let t8;
  $[21] !== schemaType || $[22] !== unstable_languageFilter ? (t8 = unstable_languageFilter.length > 0 && /* @__PURE__ */ jsx(Fragment, { children: unstable_languageFilter.map((LanguageFilterComponent, idx) => /* @__PURE__ */ jsx(LanguageFilterComponent, { schemaType }, `language-filter-${idx}`)) }), $[21] = schemaType, $[22] = unstable_languageFilter, $[23] = t8) : t8 = $[23];
  let t9;
  $[24] !== menuButtonNodes ? (t9 = menuButtonNodes.map(_temp2$c), $[24] = menuButtonNodes, $[25] = t9) : t9 = $[25];
  let t10;
  $[26] !== actions || $[27] !== editState || $[28] !== isInitialValueLoading || $[29] !== renderPaneActions ? (t10 = editState && /* @__PURE__ */ jsx(RenderActionCollectionState, { actions, actionProps: {
    ...editState,
    initialValueResolved: !isInitialValueLoading
  ...
  let t11;
  $[31] !== onPaneSplit || $[32] !== showSplitPaneButton || $[33] !== t ? (t11 = showSplitPaneButton && /* @__PURE__ */ jsx(Button$1, { "aria-label": t("buttons.split-pane-button.aria-label"), icon: SplitVerticalIcon, mode: "bleed", onClick: onPaneSplit, tooltipProps: {
    content: t("buttons.split-pane-button.tooltip")
  } }, "split-pane-button"), $[31] = onPaneSplit, $[32] = showSplitPaneButton, $[33] = t, $[34] = t11) : t11 = $[34];
  let t12;
  $[35] !== onPaneClose || $[36] !== showSplitPaneCloseButton || $[37] !== t ? (t12 = showSplitPaneCloseButton && /* @__PURE__ */ jsx(Button$1, { icon: CloseIcon, mode: "bleed", onClick: onPaneClose, tooltipProps: {
    content: t("buttons.split-pane-close-button.title")
  } }, "close-view-button"), $[35] = onPaneClose, $[36] = showSplitPaneCloseButton, $[37] = t, $[38] = t12) : t12 = $[38];
  let t13;
  $[39] !== BackLink2 || $[40] !== showPaneGroupCloseButton || $[41] !== t ? (t13 = showPaneGroupCloseButton && /* @__PURE__ */ jsx(Button$1, { icon: CloseIcon, mode: "bleed", tooltipProps: {
    content: t("buttons.split-pane-close-group-button.title")
  }, as: BackLink2 }, "close-view-button"), $[39] = BackLink2, $[40] = showPaneGroupCloseButton, $[41] = t, $[42] = t13) : t13 = $[42];
  let t14;
  $[43] !== t10 || $[44] !== t11 || $[45] !== t12 || $[46] !== t13 || $[47] !== t8 || $[48] !== t9 ? (t14 = /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 1, children: [
    t8,
    t9,
    t10,
    t11,
  ...
  let t15;
  return $[50] !== backButton || $[51] !== collapsed || $[52] !== connectionState || $[53] !== editState?.draft || $[54] !== editState?.published || $[55] !== ref || $[56] !== renderedActions || $[57] !== showGradient || $[58] !== tabIndex ? (t15 = /* @__PURE__ */ jsx(TooltipDelayGroupProvider, { children: collapsed ? /* @__PURE__ */ jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : /* @__PURE__ */ jsx(Card, { hidden: collapsed, style: {
    lineHeight: 0
...
const KeyboardShortcutResponder = memo(function(props) {
  ...
  if (!actionProps || !actions)
    return null;
  let t4;
  return $[16] !== actionProps || $[17] !== actions || $[18] !== renderDocumentActionShortcuts ? (t4 = /* @__PURE__ */ jsx(RenderActionCollectionState, { actionProps, actions, children: renderDocumentActionShortcuts }), $[16] = actionProps, $[17] = actions, $[18] = renderDocumentActionShortcuts, $[19] = t4) : t4 = $[19], t4;
});
...
function DocumentLayout() {
  ...
  let t23;
  $[74] !== rootFieldActionNodes || $[75] !== t22 ? (t23 = /* @__PURE__ */ jsx(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY$1, children: t22 }), $[74] = rootFieldActionNodes, $[75] = t22, $[76] = t23) : t23 = $[76];
  let t24;
...
function DocumentPaneProvider(props) {
  ...
  const {
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t11), [isDeleting, setIsDeleting] = useState(!1), {
    lastRevisionDocument
  } = useDocumentLastRev(documentId, documentType);
  let t12;
  $[17] !== isPristine || $[18] !== timelineReady ? (t12 = (editState) => timelineReady ? !editState?.draft && !editState?.published && !editState?.version && !isPristine : !1, $[17] = isPristine, $[18] = timelineReady, $[19] = t12) : t12 = $[19];
  ...
  let t17;
  $[38] !== params.path ? (t17 = params.path ? fromString(params.path) : EMPTY_ARRAY$2, $[38] = params.path, $[39] = t17) : t17 = $[39];
  ...
  let t28;
  $[83] !== documentId || $[84] !== documentType || $[85] !== fieldActionsResolver || $[86] !== schemaType ? (t28 = schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
  }) : [], $[83] = documentId, $[84] = documentType, $[85] = fieldActionsResolver, $[86] = schemaType, $[87] = t28) : t28 = $[87];
  ...
  let t35;
  $[105] !== buildStudioUrl || $[106] !== diffViewRouter || $[107] !== documentId || $[108] !== documentType || $[109] !== handleHistoryOpen || $[110] !== handleInspectorAction || $[111] !== previewUrl || $[112] !== previousId || $[113] !== pushToast || $[114] !== t || $[115] !== telemetry || $[116] !== toggleInlineChanges || $[117] !== value_0._id ? (t35 = async (item) => {
  ...
  }, $[105] = buildStudioUrl, $[106] = diffViewRouter, $[107] = documentId, $[108] = documentType, $[109] = handleHistoryOpen, $[110] = handleInspectorAction, $[111] = previewUrl, $[112] = previousId, $[113] = pushToast, $[114] = t, $[115] = telemetry, $[116] = toggleInlineChanges, $[117] = value_0._id, $[118] = t35) : t35 = $[118];
  ...
  }, t37 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[119] = documentId, $[120] = documentType, $[121] = onChange, $[122] = schemaType, $[123] = setDocumentMeta, $[124] = t36, $[125] = t37) : (t36 = $[124], t37 = $[125]), useEffect(t36, t37);
  let t38;
  ...
  $[131] !== actions || $[132] !== activeViewId || $[133] !== badges || $[134] !== changesOpen || $[135] !== closeInspector || $[136] !== collapsedFieldSets || $[137] !== collapsedPaths || $[138] !== compareValue || $[139] !== connectionState || $[140] !== currentDisplayed || $[141] !== documentId || $[142] !== documentIdRaw || $[143] !== documentType || $[144] !== editState_1 || $[145] !== fieldActions || $[146] !== focusPath || $[147] !== formState || $[148] !== handleHistoryClose || $[149] !== handleHistoryOpen || $[150] !== handleLegacyInspectClose || $[151] !== handleMenuAction || $[152] !== handlePaneClose || $[153] !== handlePaneSplit || $[154] !== handlePathOpen || $[155] !== hasUpstreamVersion || $[156] !== index || $[157] !== inspectOpen || $[158] !== inspectors2 || $[159] !== isDeleted_1 || $[160] !== isDeleting || $[161] !== isInitialValueLoading || $[162] !== isPermissionsLoading || $[163] !== languageFilter || $[164] !== lastNonDeletedRevId || $[165] !== lastRevisionDocument || $[166] !== onBlur || $[167] !== onChange || $[168] !== onFocus || $[169] !== onSetActiveFieldGroup || $[170] !== onSetCollapsedFieldSet || $[171] !== onSetCollapsedPath || $[172] !== openInspector || $[173] !== openPath || $[174] !== paneKey || $[175] !== permissions || $[176] !== previewUrl || $[177] !== ready || $[178] !== revisionId || $[179] !== revisionNotFound || $[180] !== schemaType || $[181] !== selectedReleaseId || $[182] !== setTimelineRange || $[183] !== t40 || $[184] !== t41 || $[185] !== timelineError || $[186] !== timelineStore || $[187] !== title || $[188] !== validation || $[189] !== value_0 || $[190] !== views ? (t42 = {
    ...
    lastNonDeletedRevId,
    lastRevisionDocument
  }, $[131] = actions, $[132] = activeViewId, $[133] = badges, $[134] = changesOpen, $[135] = closeInspector, $[136] = collapsedFieldSets, $[137] = collapsedPaths, $[138] = compareValue, $[139] = connectionState, $[140] = currentDisplayed, $[141] = documentId, $[142] = documentIdRaw, $[143] = documentType, $[144] = editState_1, $[145] = fieldActions, $[146] = focusPath, $[147] = formState, $[148] = handleHistoryClose, $[149] = handleHistoryOpen, $[150] = handleLegacyInspectClose, $[151] = handleMenuAction, $[152] = handlePaneClose, $[153] = handlePaneSplit, $[154] = handlePathOpen, $[155] = hasUpstreamVersion, $[156] = index, $[157] = inspectOpen, $[158] = inspectors2, $[159] = isDeleted_1, $[160] = isDeleting, $[161] = isInitialValueLoading, $[162] = isPermissionsLoading, $[163] = languageFilter, $[164] = lastNonDeletedRevId, $[165] = lastRevisionDocument, $[166] = onBlur, $[167] = onChange, $[168] = onFocus, $[169] = onSetActiveFieldGroup, $[170] = onSetCollapsedFieldSet, $[171] = onSetCollapsedPath, $[172] = openInspector, $[173] = openPath, $[174] = paneKey, $[175] = permissions, $[176] = previewUrl, $[177] = ready, $[178] = revisionId, $[179] = revisionNotFound, $[180] = schemaType, $[181] = selectedReleaseId, $[182] = setTimelineRange, $[183] = t40, $[184] = t41, $[185] = timelineError, $[186] = timelineStore, $[187] = title, $[188] = validation, $[189] = value_0, $[190] = views, $[191] = t42) : t42 = $[191];
  ...
  }, t44 = [formStateRef, onProgrammaticFocus, paneRouter, params, ready, enhancedObjectDialogEnabled], $[192] = enhancedObjectDialogEnabled, $[193] = formStateRef, $[194] = onProgrammaticFocus, $[195] = paneRouter, $[196] = params, $[197] = ready, $[198] = t43, $[199] = t44) : (t43 = $[198], t44 = $[199]), useEffect(t43, t44);
  let t45;
  return $[200] !== children || $[201] !== documentPane ? (t45 = /* @__PURE__ */ jsx(DocumentPaneContext.Provider, { value: documentPane, children }), $[200] = children, $[201] = documentPane, $[202] = t45) : t45 = $[202], t45;
}
