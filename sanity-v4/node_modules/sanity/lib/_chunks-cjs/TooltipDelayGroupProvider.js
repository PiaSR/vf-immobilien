"use strict";
var jsxRuntime = require("react/jsx-runtime"), reactCompilerRuntime = require("react-compiler-runtime"), ui = require("@sanity/ui"), React = require("react"), _singletons = require("../_singletons.js"), reactIs = require("react-is"), styledComponents = require("styled-components"), reactI18next = require("react-i18next");
...
`, Button = React.forwardRef(function(t0, ref) {
  ...
  let t4;
  $[7] !== mode || $[8] !== paddingY || $[9] !== ref || $[10] !== rest || $[11] !== sizeProps || $[12] !== tone ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { ...rest, ...sizeProps, paddingY, ref, mode, tone }), $[7] = mode, $[8] = paddingY, $[9] = ref, $[10] = rest, $[11] = sizeProps, $[12] = tone, $[13] = t4) : t4 = $[13];
  const children = t4;
  if (tooltipProps) {
    const t5 = tooltipProps?.content;
    let t6;
    $[14] !== children ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(TooltipButtonWrapper, { children }), $[14] = children, $[15] = t6) : t6 = $[15];
    let t7;
    return $[16] !== t5 || $[17] !== t6 || $[18] !== tooltipProps ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { content: t5, portal: !0, ...tooltipProps, children: t6 }), $[16] = t5, $[17] = t6, $[18] = tooltipProps, $[19] = t7) : t7 = $[19], t7;
  }
  return children;
...
function ErrorBoundary(t0) {
  ...
  let t2;
  return $[6] !== handleCatch || $[7] !== rest ? (t2 = /* @__PURE__ */ jsxRuntime.jsx(ui.ErrorBoundary, { ...rest, onCatch: handleCatch }), $[6] = handleCatch, $[7] = rest, $[8] = t2) : t2 = $[8], t2;
}
...
`, MenuItem = React.forwardRef(function(t0, ref) {
  ...
  let t10;
  $[36] !== disabled || $[37] !== ref || $[38] !== rest || $[39] !== t7 || $[40] !== t8 || $[41] !== t9 ? (t10 = /* @__PURE__ */ jsxRuntime.jsx(ui.MenuItem, { disabled, paddingLeft: t7, paddingRight: 3, paddingY: t8, ref, ...rest, children: t9 }), $[36] = disabled, $[37] = ref, $[38] = rest, $[39] = t7, $[40] = t8, $[41] = t9, $[42] = t10) : t10 = $[42];
  const children = t10;
  if (tooltipProps) {
    const t11 = tooltipProps?.content;
    let t12;
    $[43] !== children ? (t12 = /* @__PURE__ */ jsxRuntime.jsx("div", { children }), $[43] = children, $[44] = t12) : t12 = $[44];
    let t13;
    return $[45] !== t11 || $[46] !== t12 || $[47] !== tooltipProps ? (t13 = /* @__PURE__ */ jsxRuntime.jsx(Tooltip, { content: t11, portal: !0, ...tooltipProps, children: t12 }), $[45] = t11, $[46] = t12, $[47] = tooltipProps, $[48] = t13) : t13 = $[48], t13;
  }
  return children;
  ...
  let t1;
  return $[3] !== animate || $[4] !== ref || $[5] !== restProps ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(ui.Popover, { ...restProps, animate, ref }), $[3] = animate, $[4] = ref, $[5] = restProps, $[6] = t1) : t1 = $[6], t1;
