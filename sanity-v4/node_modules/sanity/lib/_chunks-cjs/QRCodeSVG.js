"use strict";
var jsxRuntime = require("react/jsx-runtime"), reactCompilerRuntime = require("react-compiler-runtime"), framerMotion = require("framer-motion"), React = require("react");
/**
...
function QRCodeSVGComponent(props) {
  ...
  let t8;
  $[13] !== title ? (t8 = !!title && /* @__PURE__ */ jsxRuntime.jsx("title", { children: title }), $[13] = title, $[14] = t8) : t8 = $[14];
  let t10, t11, t9;
  $[15] === Symbol.for("react.memo_cache_sentinel") ? (t9 = {
    opacity: 0
  }, t10 = {
    opacity: 2
  }, t11 = {
  ...
  let t12;
  $[18] !== color || $[19] !== fgPath ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(framerMotion.motion.path, { fill: color, d: fgPath, shapeRendering: "crispEdges", initial: t9, animate: t10, exit: t11 }), $[18] = color, $[19] = fgPath, $[20] = t12) : t12 = $[20];
  let t13;
  return $[21] !== size || $[22] !== t12 || $[23] !== t7 || $[24] !== t8 ? (t13 = /* @__PURE__ */ jsxRuntime.jsxs("svg", { height: size, width: size, viewBox: t7, role: "img", children: [
    t8,
    t12
