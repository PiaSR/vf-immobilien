...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(rxjs.distinctUntilChanged(_temp$E), rxjs.filter(t32), rxjs.map(_temp2$h)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
`, DiffViewPane = React.forwardRef(function(t0, ref) {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = sanity.useActiveReleases(), [patchChannel] = React.useState(_temp$D);
  let t2;
...
function PaneLayout(props) {
  ...
  const [controller] = React.useState(_temp$C), [rootElement, setRootElement] = React.useState(null), width = ui.useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = sanity.useListFormat(t1), {
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace), telemetry2 = react.useTelemetry(), roleTitles = currentUserRoles.map(_temp$z), roles = listFormat.formatToParts(roleTitles).map(_temp2$e);
  let t2;
  $[1] !== roles ? (t2 = {
...
const ReferenceChangedBanner = React.memo(() => {
  ...
  bb0: {
    ...
    if ($[3] !== documentPreviewStore || $[4] !== parentId || $[5] !== parentRefPath || $[6] !== parentRefPathSegment || $[7] !== selectedReleaseId) {
      const publishedId = sanity.getPublishedId(parentId), path = PathUtils.fromString(parentRefPathSegment), keyedSegmentIndex = path.findIndex(_temp$y);
      let t32;
...
`, FormHeader = (t0) => {
  ...
  const $ = reactCompilerRuntime.c(77), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = React.useState(_temp$w), isLocked = editState?.transactionSyncLock?.enabled, {
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace);
  let t0;
...
const FavoriteToggle = (t0) => {
  ...
  bb1: {
    ...
    const hasCardinalityOneReleases = filteredReleases.currentReleases.some(sanity.isCardinalityOneRelease);
...
const DISABLED_REASON_KEY$1 = {
  ...
  $[4] !== documentStore.pair || $[5] !== duplicate || $[6] !== id || $[7] !== mapDocument || $[8] !== navigateIntent || $[9] !== onComplete || $[10] !== type ? (t2 = async () => {
    ...
    setDuplicating(!0);
    const duplicateSuccess = rxjs.firstValueFrom(documentStore.pair.operationEvents(id, type).pipe(rxjs.filter(_temp$u)));
  ...
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t52;
      $[14] !== currentUser ? (t52 = /* @__PURE__ */ jsxRuntime.jsx(sanity.InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[14] = currentUser, $[15] = t52) : t52 = $[15];
      let t62;
      $[16] !== t42 || $[17] !== t52 ? (t62 = {
        icon: icons.CopyIcon,
        disabled: !0,
...
const DISABLED_REASON_KEY = {
  ...
  bb0: {
    if (isConfirmDialogOpen) {
      ...
      let t62;
      $[8] !== handleCancel || $[9] !== handleConfirm || $[10] !== t52 || $[11] !== type ? (t62 = /* @__PURE__ */ jsxRuntime.jsx(ConfirmDeleteDialogContainer, { id: t52, type, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm }), $[8] = handleCancel, $[9] = handleConfirm, $[10] = t52, $[11] = type, $[12] = t62) : t62 = $[12];
      let t7;
...
const DocumentStatusBarActionsInner = React.memo(function(props) {
  ...
  if (actions.length === 0 || !actionProps)
    return null;
  let t4;
  return $[10] !== actionProps || $[11] !== actions || $[12] !== renderDocumentStatusBarActions ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[10] = actionProps, $[11] = actions, $[12] = renderDocumentStatusBarActions, $[13] = t4) : t4 = $[13], t4;
  ...
  if (!actionProps)
    return null;
  let t4;
  return $[12] !== actionProps || $[13] !== historyActions || $[14] !== renderDocumentStatusBarActions ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actions: historyActions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[12] = actionProps, $[13] = historyActions, $[14] = renderDocumentStatusBarActions, $[15] = t4) : t4 = $[15], t4;
});
...
const TooltipContent$1 = (t0) => {
  ...
  let t20;
  $[73] !== displayed?._id || $[74] !== documentType || $[75] !== filteredReleases.inCreation || $[76] !== filteredReleases.notCurrentReleases || $[77] !== handleCopyToDraftsNavigate || $[78] !== loading || $[79] !== t ? (t20 = filteredReleases.inCreation && /* @__PURE__ */ jsxRuntime.jsx(sanity.VersionChip, { tooltipContent: /* @__PURE__ */ jsxRuntime.jsx(TooltipContent$1, { release: filteredReleases.inCreation }), selected: !0, onClick: _temp$s, locked: !1, tone: sanity.getReleaseTone(filteredReleases.inCreation), text: filteredReleases.inCreation.metadata.title || t("release.placeholder-untitled-release"), onCopyToDraftsNavigate: handleCopyToDraftsNavigate, contextValues: {
    disabled: !0,
...
const HorizontalScroller = styledComponents.styled(ui.Card)((props) => {
  ...
  } = sanity.useFieldActions(), [referenceElement, setReferenceElement] = React.useState(null), scrollContainerRef = React.useRef(null), showGradient = useChipScrollPosition(scrollContainerRef);
  let t0;
  $[0] !== allActions ? (t0 = allActions ?? [], $[0] = allActions, $[1] = t0) : t0 = $[1];
  let t1;
  ...
  $[13] !== contextMenuNodes || $[14] !== referenceElement ? (t5 = (t62) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states });
  }, $[13] = contextMenuNodes, $[14] = referenceElement, $[15] = t5) : t5 = $[15];
  const renderPaneActions = t5;
  let t6;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(DocumentHeaderTitle, {}), $[16] = t6) : t6 = $[16];
  const title = t6;
  let t7;
  $[17] !== BackLink2 || $[18] !== showBackButton || $[19] !== t ? (t7 = showBackButton && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { as: BackLink2, "data-as": "a", icon: icons.ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t("pane-header.back-button.text")
  } }), $[17] = BackLink2, $[18] = showBackButton, $[19] = t, $[20] = t7) : t7 = $[20];
  const backButton = t7;
  let t8;
  $[21] !== schemaType || $[22] !== unstable_languageFilter ? (t8 = unstable_languageFilter.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: unstable_languageFilter.map((LanguageFilterComponent, idx) => /* @__PURE__ */ jsxRuntime.jsx(LanguageFilterComponent, { schemaType }, `language-filter-${idx}`)) }), $[21] = schemaType, $[22] = unstable_languageFilter, $[23] = t8) : t8 = $[23];
  let t9;
  $[24] !== menuButtonNodes ? (t9 = menuButtonNodes.map(_temp2$c), $[24] = menuButtonNodes, $[25] = t9) : t9 = $[25];
  let t10;
  $[26] !== actions || $[27] !== editState || $[28] !== isInitialValueLoading || $[29] !== renderPaneActions ? (t10 = editState && /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actions, actionProps: {
    ...editState,
    initialValueResolved: !isInitialValueLoading
  ...
  let t11;
  $[31] !== onPaneSplit || $[32] !== showSplitPaneButton || $[33] !== t ? (t11 = showSplitPaneButton && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t("buttons.split-pane-button.aria-label"), icon: icons.SplitVerticalIcon, mode: "bleed", onClick: onPaneSplit, tooltipProps: {
    content: t("buttons.split-pane-button.tooltip")
  } }, "split-pane-button"), $[31] = onPaneSplit, $[32] = showSplitPaneButton, $[33] = t, $[34] = t11) : t11 = $[34];
  let t12;
  $[35] !== onPaneClose || $[36] !== showSplitPaneCloseButton || $[37] !== t ? (t12 = showSplitPaneCloseButton && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { icon: icons.CloseIcon, mode: "bleed", onClick: onPaneClose, tooltipProps: {
  ...
  let t13;
  $[39] !== BackLink2 || $[40] !== showPaneGroupCloseButton || $[41] !== t ? (t13 = showPaneGroupCloseButton && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { icon: icons.CloseIcon, mode: "bleed", tooltipProps: {
  ...
  let t14;
  $[43] !== t10 || $[44] !== t11 || $[45] !== t12 || $[46] !== t13 || $[47] !== t8 || $[48] !== t9 ? (t14 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 1, children: [
    t8,
    t9,
    t10,
    t11,
  ...
  let t15;
  return $[50] !== backButton || $[51] !== collapsed || $[52] !== connectionState || $[53] !== editState?.draft || $[54] !== editState?.published || $[55] !== ref || $[56] !== renderedActions || $[57] !== showGradient || $[58] !== tabIndex ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: collapsed ? /* @__PURE__ */ jsxRuntime.jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { hidden: collapsed, style: {
    lineHeight: 0
...
function TimelineMenu(t0) {
  const $ = reactCompilerRuntime.c(62), {
    ...
    ready,
    timelineStore
  } = useDocumentPane(), [open, setOpen] = React.useState(!1), [button, setButton] = React.useState(null), [popoverRef, setPopoverRef] = React.useState(null), toast = ui.useToast(), chunks = sanity.useTimelineSelector(timelineStore, _temp$o), loading = sanity.useTimelineSelector(timelineStore, _temp2$a), hasMoreChunks = sanity.useTimelineSelector(timelineStore, _temp3$6), realRevChunk = sanity.useTimelineSelector(timelineStore, _temp4$6), sinceTime = sanity.useTimelineSelector(timelineStore, _temp5$3), {
    t
  } = sanity.useTranslation("studio");
  let t1;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t1 = () => {
...
const STATUS_DICTIONARY = {
  ...
  const $ = reactCompilerRuntime.c(8), {
    timelineStore
  } = useDocumentPane(), chunks = sanity.useTimelineSelector(timelineStore, _temp$n), loading = sanity.useTimelineSelector(timelineStore, _temp2$9), event = chunks?.[0];
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = /* @__PURE__ */ jsxRuntime.jsx(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
...
const KeyboardShortcutResponder = React.memo(function(props) {
  ...
  if (!actionProps || !actions)
    return null;
  let t4;
  return $[16] !== actionProps || $[17] !== actions || $[18] !== renderDocumentActionShortcuts ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(RenderActionCollectionState, { actionProps, actions, children: renderDocumentActionShortcuts }), $[16] = actionProps, $[17] = actions, $[18] = renderDocumentActionShortcuts, $[19] = t4) : t4 = $[19], t4;
});
...
function DocumentLayout() {
  ...
  let t23;
  $[74] !== rootFieldActionNodes || $[75] !== t22 ? (t23 = /* @__PURE__ */ jsxRuntime.jsx(sanity.FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY$1, children: t22 }), $[74] = rootFieldActionNodes, $[75] = t22, $[76] = t23) : t23 = $[76];
  let t24;
...
function DocumentPaneProvider(props) {
  const $ = reactCompilerRuntime.c(203), {
    children,
    index,
    pane: pane2,
    paneKey,
  ...
  } = t1, telemetry2 = react.useTelemetry(), router2 = router$1.useRouter(), paneRouter = usePaneRouter(), setPaneParams = paneRouter.setParams, {
    push: pushToast
  } = ui.useToast(), {
    options,
    menuItemGroups: t2,
  ...
  const viewsProp = t5, paneOptions = sanity.useUnique(options), documentIdRaw = paneOptions.id;
  let t6;
  $[2] !== documentIdRaw ? (t6 = sanity.getPublishedId(documentIdRaw), $[2] = documentIdRaw, $[3] = t6) : t6 = $[3];
  const documentId = t6, documentType = options.type, params = sanity.useUnique(paneRouter.params) || EMPTY_PARAMS$2, {
    buildStudioUrl
  ...
  const {
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t11), [isDeleting, setIsDeleting] = React.useState(!1), {
    lastRevisionDocument
  ...
  let t17;
  $[38] !== params.path ? (t17 = params.path ? PathUtils.fromString(params.path) : sanity.EMPTY_ARRAY, $[38] = params.path, $[39] = t17) : t17 = $[39];
  ...
  const languageFilter = t27, views = sanity.useUnique(viewsProp), activeViewId = params.view || views[0] && views[0].id || null, previewUrl = usePreviewUrl(value_0), {
    t
  } = sanity.useTranslation(StructureToolProvider.structureLocaleNamespace);
  let t28;
  ...
  let t34;
  $[102] !== router2 || $[103] !== telemetry2 ? (t34 = () => {
  ...
  }, $[102] = router2, $[103] = telemetry2, $[104] = t34) : t34 = $[104];
  const toggleInlineChanges = t34;
  let t35;
  $[105] !== buildStudioUrl || $[106] !== diffViewRouter || $[107] !== documentId || $[108] !== documentType || $[109] !== handleHistoryOpen || $[110] !== handleInspectorAction || $[111] !== previewUrl || $[112] !== previousId || $[113] !== pushToast || $[114] !== t || $[115] !== telemetry2 || $[116] !== toggleInlineChanges || $[117] !== value_0._id ? (t35 = async (item) => {
  ...
  }, $[105] = buildStudioUrl, $[106] = diffViewRouter, $[107] = documentId, $[108] = documentType, $[109] = handleHistoryOpen, $[110] = handleInspectorAction, $[111] = previewUrl, $[112] = previousId, $[113] = pushToast, $[114] = t, $[115] = telemetry2, $[116] = toggleInlineChanges, $[117] = value_0._id, $[118] = t35) : t35 = $[118];
  ...
  }, t37 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[119] = documentId, $[120] = documentType, $[121] = onChange, $[122] = schemaType, $[123] = setDocumentMeta, $[124] = t36, $[125] = t37) : (t36 = $[124], t37 = $[125]), React.useEffect(t36, t37);
  let t38;
  ...
  const documentPane = t42, pathRef = React.useRef(void 0);
  let t43, t44;
  ...
  }, t44 = [formStateRef, onProgrammaticFocus, paneRouter, params, ready, enhancedObjectDialogEnabled], $[192] = enhancedObjectDialogEnabled, $[193] = formStateRef, $[194] = onProgrammaticFocus, $[195] = paneRouter, $[196] = params, $[197] = ready, $[198] = t43, $[199] = t44) : (t43 = $[198], t44 = $[199]), React.useEffect(t43, t44);
  let t45;
  return $[200] !== children || $[201] !== documentPane ? (t45 = /* @__PURE__ */ jsxRuntime.jsx(_singletons.DocumentPaneContext.Provider, { value: documentPane, children }), $[200] = children, $[201] = documentPane, $[202] = t45) : t45 = $[202], t45;
}
...
function EventsInspector(t0) {
  ...
  let t16;
  $[59] !== diffLoading || $[60] !== t ? (t16 = diffLoading && /* @__PURE__ */ jsxRuntime.jsx(framerMotion.motion.div, { animate: {
    opacity: 1
  }, initial: {
    opacity: 0
  }, transition: {
