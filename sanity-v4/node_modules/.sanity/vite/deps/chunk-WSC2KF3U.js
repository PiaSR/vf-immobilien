...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-MIG2GZWU.js")
});
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(77), {
    hidden,
    margins
  } = props, {
    collapsedFieldSets,
...
function DocumentLayout() {
  ...
  }), [currentInspector, documentIdStack, features, hasValue, inspectorMenuItems, inspectors2, previewUrl, t2, stickyParams.displayInlineChanges]), handleKeyUp = (0, import_react2.useCallback)((event) => {
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  const {
  ...
  } = useSource(), telemetry = useTelemetry(), router2 = useRouter(), paneRouter = usePaneRouter(), setPaneParams = paneRouter.setParams, {
    push: pushToast
  } = useToast(), {
    options,
    ...
    displayInlineChanges: router2.stickyParams.displayInlineChanges === "true"
  }), {
    data: releases = []
  ...
  }, [params, setPaneParams]), handlePaneClose = (0, import_react2.useCallback)(() => paneRouter.closeCurrent(), [paneRouter]), handlePaneSplit = (0, import_react2.useCallback)(() => paneRouter.duplicateCurrent(), [paneRouter]), toggleInlineChanges = (0, import_react2.useCallback)(() => {
  ...
  }, [router2, telemetry]), handleMenuAction = (0, import_react2.useCallback)(async (item) => {
  ...
  }, [previewUrl, previousId, telemetry, buildStudioUrl, pushToast, t2, documentId, documentType, handleHistoryOpen, handleInspectorAction, diffViewRouter, value_0._id, toggleInlineChanges]);
  (0, import_react2.useEffect)(() => {
    setDocumentMeta({
      documentId,
      documentType,
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-426HX6AH.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-6CQLF52O.js"))
};
...
function PublishedEventMenu(t0) {
  ...
  const VersionBadge = t4, isMenuDisabled = event.release && !isReleaseDocument(event.release), t5 = `timeline-item-menu-button-${event.versionId}`;
  let t6;
  $[14] !== t2 ? (t6 = t2("timeline-item.menu-button.aria-label"), $[14] = t2, $[15] = t6) : t6 = $[15];
  let t7;
  $[16] !== event.release || $[17] !== isMenuDisabled || $[18] !== t2 ? (t7 = isMenuDisabled ? t2("timeline-item.not-found-release.tooltip", {
    releaseId: event.release?._id ? getReleaseIdFromReleaseDocumentId(event.release._id) : void 0
  }) : t2("timeline-item.menu-button.tooltip"), $[16] = event.release, $[17] = isMenuDisabled, $[18] = t2, $[19] = t7) : t7 = $[19];
  let t8;
  $[20] !== t7 ? (t8 = {
    content: t7
  }, $[20] = t7, $[21] = t8) : t8 = $[21];
  let t9;
  $[22] !== isMenuDisabled || $[23] !== t6 || $[24] !== t8 ? (t9 = (0, import_jsx_runtime2.jsx)(ContextMenuButton, { "aria-label": t6, tooltipProps: t8, disabled: isMenuDisabled }), $[22] = isMenuDisabled, $[23] = t6, $[24] = t8, $[25] = t9) : t9 = $[25];
  let t10;
  $[26] !== VersionBadge || $[27] !== event.release || $[28] !== event.versionRevisionId || $[29] !== handleOpenDraftDocument || $[30] !== handleOpenReleaseDocument || $[31] !== t2 || $[32] !== tCore ? (t10 = (0, import_jsx_runtime2.jsx)(Menu, { padding: 1, children: event.release ? (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
  ...
  }, i18nKey: "events.open.draft", t: t2 }) }) }) }) }), $[26] = VersionBadge, $[27] = event.release, $[28] = event.versionRevisionId, $[29] = handleOpenDraftDocument, $[30] = handleOpenReleaseDocument, $[31] = t2, $[32] = tCore, $[33] = t10) : t10 = $[33];
  const t11 = portalContext.elements?.[TIMELINE_MENU_PORTAL$1] ? TIMELINE_MENU_PORTAL$1 : true;
  let t12;
  $[34] === Symbol.for("react.memo_cache_sentinel") ? (t12 = ["bottom-end", "bottom-start"], $[34] = t12) : t12 = $[34];
  let t13;
  $[35] !== t11 ? (t13 = {
    portal: t11,
    placement: "bottom",
    fallbackPlacements: t12
  }, $[35] = t11, $[36] = t13) : t13 = $[36];
  let t14;
  return $[37] !== t10 || $[38] !== t13 || $[39] !== t5 || $[40] !== t9 ? (t14 = (0, import_jsx_runtime2.jsx)(MenuButton, { id: t5, button: t9, menu: t10, popover: t13 }), $[37] = t10, $[38] = t13, $[39] = t5, $[40] = t9, $[41] = t14) : t14 = $[41], t14;
}
function _temp$1(t0) {
  const {
    children: children_2
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-EDYNW2PM.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-WSC2KF3U.js.map
