...
import {
  ...
  usePortal,
  useToast
} from "./chunk-4XXHWF2J.js";
import {
  require_dist
} from "./chunk-IR37CHXO.js";
import {
  require_jsx_runtime
} from "./chunk-SSFUK7K4.js";
import {
  require_react
} from "./chunk-PB2JVMMV.js";
import {
  __commonJS,
  __toESM
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-34QMTHPG.js")
});
...
var VersionModeHeader = ({
  ...
  }, [documents?.previous, navigateDiffView]), onSelectNextRelease = (0, import_react2.useCallback)((selectedDocumentId_0) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(VersionModeHeaderLayout, { children: [
    (0, import_jsx_runtime2.jsxs)(VersionModeHeaderLayoutSection, { children: [
      ...
      typeof documents?.previous < "u" && (0, import_jsx_runtime2.jsx)(VersionMenu, { releases, onSelectRelease: onSelectPreviousRelease, role: "previous", documentId, state: state2, document: documents.previous })
    ] }),
    ...
    (0, import_jsx_runtime2.jsxs)(VersionModeHeaderLayoutSection, { children: [
      typeof documents?.next < "u" && (0, import_jsx_runtime2.jsx)(VersionMenu, { releases, onSelectRelease: onSelectNextRelease, role: "next", documentId, state: state2, document: documents.next }),
...
var VersionMenu = ({
  ...
  return (0, import_jsx_runtime2.jsx)(MenuButton, { id: role, button: (0, import_jsx_runtime2.jsx)(Button, { type: "button", mode: "bleed", padding: 2, paddingRight: 3, radius: "full", selected: true, ...getMenuButtonProps({
    ...
    releases.map((release) => (0, import_jsx_runtime2.jsx)(VersionMenuItem, { release, onSelect: onSelectRelease, isSelected: typeof selected != "string" && selected?._id === release._id, documentId }, release._id))
  ] }) });
};
var VersionMenuItem = ({
  type,
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$q), filter(t32), map(_temp2$9)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), [patchChannel] = (0, import_react2.useState)(_temp$p);
  let t2;
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$o), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function useFilteredReleases({
  ...
  return (0, import_react2.useMemo)(() => {
    ...
    const archivedRelease = archivedReleases.find((r2) => getReleaseIdFromReleaseDocumentId(r2._id) === params?.historyVersion);
...
function useDocumentTitle() {
  const $ = (0, import_react_compiler_runtime.c)(22), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), documentValue = isDeleted ? lastRevisionDocument : editState?.version || editState?.draft || editState?.published, subscribed = !!documentValue;
  let t0;
  bb0: {
    if (isDeleted && lastRevisionDocument && schemaType)
      try {
        let t222;
        $[0] !== lastRevisionDocument || $[1] !== schemaType ? (t222 = prepareForPreview(lastRevisionDocument, schemaType), $[0] = lastRevisionDocument, $[1] = schemaType, $[2] = t222) : t222 = $[2], t0 = t222;
        break bb0;
      } catch (t12) {
        console.warn("Failed to prepare preview for deleted document:", t12), t0 = null;
        break bb0;
      }
    t0 = null;
  }
  const deletedDocumentPreview = t0, t1 = subscribed && !isDeleted;
  let t22;
  $[3] !== documentValue || $[4] !== schemaType || $[5] !== t1 ? (t22 = {
    enabled: t1,
    schemaType,
    value: documentValue
  }, $[3] = documentValue, $[4] = schemaType, $[5] = t1, $[6] = t22) : t22 = $[6];
  const {
    error: error_0,
    value
  } = useDocumentPreview(t22);
  if (connectionState === "connecting" && !subscribed) {
    let t32;
    return $[7] === Symbol.for("react.memo_cache_sentinel") ? (t32 = {
      error: void 0,
      title: void 0
    }, $[7] = t32) : t32 = $[7], t32;
  }
  if (isDeleted && deletedDocumentPreview) {
    let t32;
    return $[8] !== deletedDocumentPreview.title ? (t32 = {
      error: void 0,
      title: deletedDocumentPreview.title
    }, $[8] = deletedDocumentPreview.title, $[9] = t32) : t32 = $[9], t32;
  }
  if (!value && !isDeleted) {
    const t32 = schemaType?.title || schemaType?.name;
    let t42;
    $[10] !== t2 || $[11] !== t32 ? (t42 = t2("panes.document-header-title.new.text", {
      schemaType: t32
    }), $[10] = t2, $[11] = t32, $[12] = t42) : t42 = $[12];
    let t5;
    return $[13] !== t42 ? (t5 = {
      error: void 0,
      title: t42
    }, $[13] = t42, $[14] = t5) : t5 = $[14], t5;
  }
  if (error_0) {
    let t32;
    $[15] !== error_0.message || $[16] !== t2 ? (t32 = t2("panes.document-list-pane.error.text", {
      error: error_0.message
    }), $[15] = error_0.message, $[16] = t2, $[17] = t32) : t32 = $[17];
    let t42;
    return $[18] !== t32 ? (t42 = {
      error: t32,
      title: void 0
    }, $[18] = t32, $[19] = t42) : t42 = $[19], t42;
  }
  const t3 = value?.title;
  let t4;
  return $[20] !== t3 ? (t4 = {
    error: void 0,
    title: t3
  }, $[20] = t3, $[21] = t4) : t4 = $[21], t4;
}
...
function useStructureToolSetting(namespace, key, defaultValue) {
  ...
  let t2;
  $[9] !== keyValueStore || $[10] !== keyValueStoreKey || $[11] !== value_0 ? (t2 = (newValue) => {
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = useListFormat(t1), {
    t: t2
  } = useTranslation(structureLocaleNamespace), telemetry = useTelemetry(), roleTitles = currentUserRoles.map(_temp$m), roles = listFormat.formatToParts(roleTitles).map(_temp2$7);
  let t22;
  $[1] !== roles ? (t22 = {
...
var ReferenceChangedBanner = (0, import_react2.memo)(() => {
  const documentPreviewStore = useDocumentPreviewStore(), {
    ...
    replaceCurrent,
    BackLink: BackLink2
  } = usePaneRouter(), routerReferenceId = routerPanesState[groupIndex]?.[0].id, parentSibling = routerPanesState[groupIndex - 1]?.[0], parentId = parentSibling?.id, hasHistoryOpen = !!parentSibling?.params?.rev, parentRefPath = (0, import_react2.useMemo)(() => params?.parentRefPath && fromString(params.parentRefPath) || null, [params?.parentRefPath]), {
    t: t2
  ...
  return (
    ...
    referenceInfo.result?.refValue === routerReferenceId ? null : (0, import_jsx_runtime2.jsx)(Banner, { action: referenceInfo.result?.refValue ? {
    ...
    }, "data-testid": "reference-changed-banner", content: (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: referenceInfo.result?.refValue ? t2("banners.reference-changed-banner.reason-changed.text") : t2("banners.reference-changed-banner.reason-removed.text") }), icon: WarningOutlineIcon, tone: "caution" })
  );
});
...
function ArchivedReleaseDocumentBanner() {
  ...
  }, release = (0, import_react2.useMemo)(() => archivedReleases.find((r2) => getReleaseIdFromReleaseDocumentId(r2._id) === params?.historyVersion), [archivedReleases, params?.historyVersion]), description = release?.state === "published" ? "banners.published-release.description" : "banners.archived-release.description", title = release?.metadata.title || tCore("release.placeholder-untitled-release");
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  let t22;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$l), $[6] = t22) : t22 = $[6];
...
function DocumentNotInReleaseBanner({
  ...
  }, [createVersion, currentRelease._id, documentId, t2, toast]), now = useCurrentTime(200);
...
function OpenReleaseToEditBannerInner({
  ...
  return (0, import_jsx_runtime2.jsx)(Banner, { tone, "data-testid": "open-release-to-edit-banner", content: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Flex, { direction: "row", gap: 1, wrap: "wrap", children: documentVersionsTitleList.length > 1 ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "banners.release.navigate-to-edit-description-multiple", components: {
    ...
    text: t2("banners.release.action.open-to-edit"),
    tone,
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(74), {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$k), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
  ...
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = connectionState, $[43] = documentId, $[44] = editState?.draft, $[45] = editState?.published, $[46] = fieldActions, $[47] = formState, $[48] = hidden, $[49] = isReadOnly, $[50] = onBlur, $[51] = onChange, $[52] = onFocus, $[53] = onPathOpen, $[54] = onSetActiveFieldGroup, $[55] = onSetCollapsedFieldSet, $[56] = onSetCollapsedPath, $[57] = openPath, $[58] = patchChannel, $[59] = presence, $[60] = t2, $[61] = title, $[62] = validation, $[63] = t13) : t13 = $[63];
  let t14;
  $[64] !== setRef || $[65] !== t12 || $[66] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[64] = setRef, $[65] = t12, $[66] = t13, $[67] = t14) : t14 = $[67];
  let t15;
  $[68] !== margins || $[69] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(PresenceOverlay, { margins, children: t14 }), $[68] = margins, $[69] = t14, $[70] = t15) : t15 = $[70];
  let t16;
  return $[71] !== hidden || $[72] !== t15 ? (t16 = (0, import_jsx_runtime2.jsx)(Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[71] = hidden, $[72] = t15, $[73] = t16) : t16 = $[73], t16;
});
...
function DocumentHeaderTitle() {
  ...
  if (connectionState === "connecting" && !subscribed) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (title) {
    let t02;
    return $[1] !== title ? (t02 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: title }), $[1] = title, $[2] = t02) : t02 = $[2], t02;
  }
  if (!documentValue) {
    const t02 = schemaType?.title || schemaType?.name;
    let t12;
    $[3] !== t2 || $[4] !== t02 ? (t12 = t2("panes.document-header-title.new.text", {
      schemaType: t02
    }), $[3] = t2, $[4] = t02, $[5] = t12) : t12 = $[5];
    let t22;
    return $[6] !== t12 ? (t22 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t12 }), $[6] = t12, $[7] = t22) : t22 = $[7], t22;
  }
  if (error) {
    let t02;
    $[8] !== error || $[9] !== t2 ? (t02 = t2("panes.document-header-title.error.text", {
      error
    }), $[8] = error, $[9] = t2, $[10] = t02) : t02 = $[10];
    let t12;
    return $[11] !== t02 ? (t12 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t02 }), $[11] = t02, $[12] = t12) : t12 = $[12], t12;
  }
  let t0;
  $[13] !== documentTitle || $[14] !== t2 ? (t0 = documentTitle || (0, import_jsx_runtime2.jsx)("span", { style: {
    color: "var(--card-muted-fg-color)"
  }, children: t2("panes.document-header-title.untitled.text") }), $[13] = documentTitle, $[14] = t2, $[15] = t0) : t0 = $[15];
  let t1;
  return $[16] !== t0 ? (t1 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t0 }), $[16] = t0, $[17] = t1) : t1 = $[17], t1;
}
...
var DocumentPanelSubHeader = (0, import_react2.memo)(function() {
  ...
  let t1;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime2.jsx)(DocumentHeaderTitle, {}), $[2] = t1) : t1 = $[2];
  const title = t1;
  let t22;
  $[3] !== showTabs ? (t22 = showTabs && (0, import_jsx_runtime2.jsx)(DocumentHeaderTabs, {}), $[3] = showTabs, $[4] = t22) : t22 = $[4];
  const tabs = t22;
  let t3;
  $[5] !== BackLink2 || $[6] !== showBackButton || $[7] !== t2 ? (t3 = showBackButton && (0, import_jsx_runtime2.jsx)(Button2, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t2("pane-header.back-button.text")
  } }), $[5] = BackLink2, $[6] = showBackButton, $[7] = t2, $[8] = t3) : t3 = $[8];
  const backButton = t3, t4 = displayed?._type ?? "";
  let t5;
  $[9] !== activeWorkspace.dataset || $[10] !== activeWorkspace.projectId ? (t5 = [activeWorkspace.projectId, activeWorkspace.dataset], $[9] = activeWorkspace.dataset, $[10] = activeWorkspace.projectId, $[11] = t5) : t5 = $[11];
  const t6 = t5.join("."), t7 = (editState?.ready && (editState.version ?? editState.draft ?? editState.published) !== null) ?? false;
  let t8;
  $[12] !== activeWorkspace.dataset || $[13] !== activeWorkspace.name || $[14] !== activeWorkspace.projectId || $[15] !== publishedDocId || $[16] !== t4 || $[17] !== t6 || $[18] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(CapabilityGate, { capability: "comlink", condition: "available", children: (0, import_jsx_runtime2.jsx)(FavoriteToggle, { resourceType: "studio", documentId: publishedDocId, documentType: t4, resourceId: t6, schemaName: activeWorkspace.name, projectId: activeWorkspace.projectId, dataset: activeWorkspace.dataset, documentExists: t7 }) }), $[12] = activeWorkspace.dataset, $[13] = activeWorkspace.name, $[14] = activeWorkspace.projectId, $[15] = publishedDocId, $[16] = t4, $[17] = t6, $[18] = t7, $[19] = t8) : t8 = $[19];
  const favoriteToggle = t8, t9 = connectionState === "connecting" && !editState?.draft && !editState?.published;
  let t10;
  return $[20] !== backButton || $[21] !== favoriteToggle || $[22] !== t9 || $[23] !== tabIndex || $[24] !== tabs ? (t10 = (0, import_jsx_runtime2.jsx)(PaneHeader$1, { loading: t9, title, tabs, tabIndex, backButton, appendTitle: favoriteToggle }), $[20] = backButton, $[21] = favoriteToggle, $[22] = t9, $[23] = tabIndex, $[24] = tabs, $[25] = t10) : t10 = $[25], t10;
});
...
var DocumentPanel = function(props) {
  const $ = (0, import_react_compiler_runtime.c)(101), {
    footerHeight,
    headerHeight,
    isInspectOpen,
    rootElement,
  ...
  bb1: {
    if (params?.historyVersion) {
      let t113;
      $[34] === Symbol.for("react.memo_cache_sentinel") ? (t113 = (0, import_jsx_runtime2.jsx)(ArchivedReleaseDocumentBanner, {}), $[34] = t113) : t113 = $[34], t10 = t113;
      break bb1;
    }
    let t112;
    $[35] !== selectedPerspective ? (t112 = isReleaseDocument(selectedPerspective) && isReleaseScheduledOrScheduling(selectedPerspective), $[35] = selectedPerspective, $[36] = t112) : t112 = $[36];
    const isScheduledRelease = t112, documentInScheduledRelease = !!(isScheduledRelease && displayed?._id && getVersionFromId(displayed?._id) === selectedReleaseId);
    let isSelectedPerspectiveWriteable, t122;
    if ($[37] !== editState || $[38] !== schemaType || $[39] !== selectedPerspective || $[40] !== workspace.document.drafts.enabled ? (isSelectedPerspectiveWriteable = isPerspectiveWriteable({
      ...
      schemaType
    }), t122 = mustChooseNewDocumentDestination({
      isSelectedPerspectiveWriteable,
      editState
    }), $[37] = editState, $[38] = schemaType, $[39] = selectedPerspective, $[40] = workspace.document.drafts.enabled, $[41] = isSelectedPerspectiveWriteable, $[42] = t122) : (isSelectedPerspectiveWriteable = $[41], t122 = $[42]), t122) {
      let t133;
      $[43] !== isSelectedPerspectiveWriteable.reason || $[44] !== isSelectedPerspectiveWriteable.result || $[45] !== schemaType || $[46] !== selectedPerspective ? (t133 = !isSelectedPerspectiveWriteable.result && (0, import_jsx_runtime2.jsx)(ChooseNewDocumentDestinationBanner, { schemaType, selectedPerspective, reason: isSelectedPerspectiveWriteable.reason }), $[43] = isSelectedPerspectiveWriteable.reason, $[44] = isSelectedPerspectiveWriteable.result, $[45] = schemaType, $[46] = selectedPerspective, $[47] = t133) : t133 = $[47], t10 = t133;
      break bb1;
    }
    if (documentInScheduledRelease) {
      const t133 = selectedPerspective;
      let t142;
      $[48] !== t133 ? (t142 = (0, import_jsx_runtime2.jsx)(ScheduledReleaseBanner, { currentRelease: t133 }), $[48] = t133, $[49] = t142) : t142 = $[49], t10 = t142;
      break bb1;
    }
    let t132;
    $[50] !== selectedPerspective ? (t132 = isSystemBundle(selectedPerspective), $[50] = selectedPerspective, $[51] = t132) : t132 = $[51];
    const isPinnedDraftOrPublish = t132, isCurrentVersionGoingToUnpublish = editState?.version && isGoingToUnpublish(editState?.version);
    if (displayed?._id && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === false && !isCurrentVersionGoingToUnpublish) {
      const t142 = selectedPerspective;
      let t152;
      $[52] !== isScheduledRelease || $[53] !== t142 || $[54] !== value._id ? (t152 = (0, import_jsx_runtime2.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t142, isScheduledRelease }), $[52] = isScheduledRelease, $[53] = t142, $[54] = value._id, $[55] = t152) : t152 = $[55], t10 = t152;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t142;
        $[56] !== displayed || $[57] !== documentId || $[58] !== schemaType ? (t142 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[56] = displayed, $[57] = documentId, $[58] = schemaType, $[59] = t142) : t142 = $[59], t10 = t142;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t142;
        $[60] !== displayed || $[61] !== documentId || $[62] !== schemaType ? (t142 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: true }), $[60] = displayed, $[61] = documentId, $[62] = schemaType, $[63] = t142) : t142 = $[63], t10 = t142;
        break bb1;
      }
    }
    ...
    let t14;
    $[64] !== showCreateBanner ? (t14 = showCreateBanner && (0, import_jsx_runtime2.jsx)(CreateLinkedBanner, {}), $[64] = showCreateBanner, $[65] = t14) : t14 = $[65];
    let t15;
    $[66] !== permissions?.granted || $[67] !== requiredPermission ? (t15 = !permissions?.granted && (0, import_jsx_runtime2.jsx)(InsufficientPermissionBanner, { requiredPermission }), $[66] = permissions?.granted, $[67] = requiredPermission, $[68] = t15) : t15 = $[68];
    let t16, t17, t18, t19, t20, t21;
    $[69] === Symbol.for("react.memo_cache_sentinel") ? (t16 = (0, import_jsx_runtime2.jsx)(RevisionNotFoundBanner, {}), t17 = (0, import_jsx_runtime2.jsx)(ReferenceChangedBanner, {}), t18 = (0, import_jsx_runtime2.jsx)(DeprecatedDocumentTypeBanner, {}), t19 = (0, import_jsx_runtime2.jsx)(CanvasLinkedBanner, {}), t20 = (0, import_jsx_runtime2.jsx)(DeletedDocumentBanners, {}), t21 = (0, import_jsx_runtime2.jsx)(UnpublishedDocumentBanner, {}), $[69] = t16, $[70] = t17, $[71] = t18, $[72] = t19, $[73] = t20, $[74] = t21) : (t16 = $[69], t17 = $[70], t18 = $[71], t19 = $[72], t20 = $[73], t21 = $[74]);
    const t22 = displayed?._id ?? documentId;
    let t23;
    $[75] !== isPinnedDraftOrPublish || $[76] !== t22 ? (t23 = (0, import_jsx_runtime2.jsx)(OpenReleaseToEditBanner, { documentId: t22, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[75] = isPinnedDraftOrPublish, $[76] = t22, $[77] = t23) : t23 = $[77];
    let t24;
    $[78] !== t14 || $[79] !== t15 || $[80] !== t23 ? (t24 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      t14,
      t15,
      t16,
      t17,
      ...
      t21,
      t23
    ] }), $[78] = t14, $[79] = t15, $[80] = t23, $[81] = t24) : t24 = $[81], t10 = t24;
  }
  const banners = t10, showFormView = features.resizablePanes || !showInspector;
  let t11;
  $[82] !== activeViewNode || $[83] !== banners || $[84] !== documentScrollElement || $[85] !== footer || $[86] !== formViewHidden || $[87] !== inspectDialog || $[88] !== layoutCollapsed || $[89] !== margins || $[90] !== portalElement || $[91] !== showFormView ? (t11 = showFormView && (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    ...
    footer
  ] }), $[82] = activeViewNode, $[83] = banners, $[84] = documentScrollElement, $[85] = footer, $[86] = formViewHidden, $[87] = inspectDialog, $[88] = layoutCollapsed, $[89] = margins, $[90] = portalElement, $[91] = showFormView, $[92] = t11) : t11 = $[92];
  let t12;
  $[93] !== documentId || $[94] !== rootElement || $[95] !== schemaType || $[96] !== showInspector ? (t12 = showInspector && (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: rootElement, children: (0, import_jsx_runtime2.jsx)(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[93] = documentId, $[94] = rootElement, $[95] = schemaType, $[96] = showInspector, $[97] = t12) : t12 = $[97];
  let t13;
  return $[98] !== t11 || $[99] !== t12 ? (t13 = (0, import_jsx_runtime2.jsx)(PaneContent, { children: (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", children: [
    t11,
    t12
  ] }) }), $[98] = t11, $[99] = t12, $[100] = t13) : t13 = $[100], t13;
};
...
function ActionMenuListItem(props) {
  ...
  let t1;
  $[4] !== actionState.shortcut ? (t1 = actionState.shortcut ? String(actionState.shortcut).split("+").map(_temp$j) : void 0, $[4] = actionState.shortcut, $[5] = t1) : t1 = $[5];
  const hotkeys = t1, t2 = `action-${actionState.label.replace(" ", "")}`, t3 = disabled || !!actionState.disabled;
  let t4;
  $[6] !== actionState.disabled || $[7] !== actionState.title ? (t4 = actionState.disabled && {
    tooltipProps: {
      content: actionState.title
    }
  }, $[6] = actionState.disabled, $[7] = actionState.title, $[8] = t4) : t4 = $[8];
  let t5;
  return $[9] !== actionState.icon || $[10] !== actionState.label || $[11] !== actionState.tone || $[12] !== handleClick || $[13] !== hotkeys || $[14] !== t2 || $[15] !== t3 || $[16] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(MenuItem2, { "data-testid": t2, disabled: t3, hotkeys, icon: actionState.icon, onClick: handleClick, text: actionState.label, tone: actionState.tone, ...t4 }), $[9] = actionState.icon, $[10] = actionState.label, $[11] = actionState.tone, $[12] = handleClick, $[13] = hotkeys, $[14] = t2, $[15] = t3, $[16] = t4, $[17] = t5) : t5 = $[17], t5;
}
function _temp$j(s2) {
...
var DiscardChangesAction = ({
  ...
  const {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), isPublished = displayed?._id && isPublishedId(displayed?._id), handleConfirm = (0, import_react2.useCallback)(() => {
  ...
  return (0, import_react2.useMemo)(() => !published || liveEdit || isPublished ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: true,
    ...
    onHandle: handle,
    dialog
  }, [currentUser, dialog, discardChanges.disabled, handle, isPermissionsLoading, isPublished, liveEdit, permissions?.granted, published, t2]);
};
...
var DuplicateAction = ({
  ...
  return (0, import_react2.useMemo)(() => !isPermissionsLoading && !permissions?.granted ? {
    icon: CopyIcon,
    disabled: true,
    ...
    onHandle: handle
  }, [currentUser, duplicate.disabled, handle, isDuplicating, isPermissionsLoading, permissions?.granted, t2]);
};
...
var PublishAction = (props) => {
  const $ = (0, import_react_compiler_runtime.c)(79), {
    id,
    type,
    liveEdit,
    draft,
...
var UnpublishAction = ({
  ...
  const {
    ...
    selectedPerspective
  } = usePerspective(), isDraft = selectedPerspective === "drafts", handleCancel = (0, import_react2.useCallback)(() => {
    setConfirmDialogOpen(false), onComplete();
    ...
    type: "dialog",
    onClose: onComplete,
    content: (0, import_jsx_runtime2.jsx)(ConfirmDeleteDialogContainer, { id: draft?._id || id, type, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm })
  } : null, [draft, id, handleCancel, handleConfirm, isConfirmDialogOpen, onComplete, type]);
  return (0, import_react2.useMemo)(() => release || isDraft || liveEdit ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    icon: UnpublishIcon,
    label: "Unpublish",
    ...
    dialog
  }, [release, isDraft, liveEdit, isPermissionsLoading, permissions?.granted, unpublish.disabled, t2, dialog, currentUser]);
};
...
var DocumentStatusBarActionsInner = (0, import_react2.memo)(function(props) {
  ...
  let t1;
  $[11] !== firstActionState || $[12] !== menuActionStates || $[13] !== showFirstActionButton ? (t1 = showFirstActionButton ? menuActionStates : [firstActionState, ...menuActionStates], $[11] = firstActionState, $[12] = menuActionStates, $[13] = showFirstActionButton, $[14] = t1) : t1 = $[14];
  const sideMenuItems = t1, t2 = __internal_tasks && __internal_tasks.footerAction;
  let t3;
  $[15] !== disabled || $[16] !== firstActionState || $[17] !== showFirstActionButton || $[18] !== tooltipContent ? (t3 = showFirstActionButton && (0, import_jsx_runtime2.jsx)(LayerProvider, { zOffset: 200, children: (0, import_jsx_runtime2.jsx)(Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: (0, import_jsx_runtime2.jsx)(Stack, { children: (0, import_jsx_runtime2.jsx)(Button2, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[15] = disabled, $[16] = firstActionState, $[17] = showFirstActionButton, $[18] = tooltipContent, $[19] = t3) : t3 = $[19];
  let t4;
  $[20] !== disabled || $[21] !== sideMenuItems ? (t4 = sideMenuItems.length > 0 && (0, import_jsx_runtime2.jsx)(ActionMenuButton, { actionStates: sideMenuItems, disabled }), $[20] = disabled, $[21] = sideMenuItems, $[22] = t4) : t4 = $[22];
  let t5;
  $[23] !== buttonElement || $[24] !== firstActionState ? (t5 = firstActionState && firstActionState.dialog && (0, import_jsx_runtime2.jsx)(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[23] = buttonElement, $[24] = firstActionState, $[25] = t5) : t5 = $[25];
  let t6;
  return $[26] !== t2 || $[27] !== t3 || $[28] !== t4 || $[29] !== t5 ? (t6 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
    t2,
    t3,
    t4,
    t5
  ] }), $[26] = t2, $[27] = t3, $[28] = t4, $[29] = t5, $[30] = t6) : t6 = $[30], t6;
});
var DocumentStatusBarActions = (0, import_react2.memo)(function() {
  ...
  let t0;
  $[0] !== allActions ? (t0 = allActions ?? [], $[0] = allActions, $[1] = t0) : t0 = $[1];
  let t1;
  $[2] !== t0 ? (t1 = t0.filter(_temp2$6), $[2] = t0, $[3] = t1) : t1 = $[3];
  const actions = t1;
  let t2;
  $[4] !== editState || $[5] !== isInitialValueLoading ? (t2 = editState ? {
    ...editState,
    initialValueResolved: !isInitialValueLoading
  } : null, $[4] = editState, $[5] = isInitialValueLoading, $[6] = t2) : t2 = $[6];
  const actionProps = t2;
  let t3;
  $[7] !== connectionState || $[8] !== documentId ? (t3 = (t42) => {
    const {
      states
    } = t42;
    return (0, import_jsx_runtime2.jsx)(DocumentStatusBarActionsInner, { disabled: connectionState !== "connected", states }, documentId);
  }, $[7] = connectionState, $[8] = documentId, $[9] = t3) : t3 = $[9];
  const renderDocumentStatusBarActions = t3;
  if (actions.length === 0 || !actionProps)
    return null;
  let t4;
  return $[10] !== actionProps || $[11] !== actions || $[12] !== renderDocumentStatusBarActions ? (t4 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[10] = actionProps, $[11] = actions, $[12] = renderDocumentStatusBarActions, $[13] = t4) : t4 = $[13], t4;
});
var HistoryStatusBarActions = (0, import_react2.memo)(function() {
  ...
  let t0;
  $[0] !== editState || $[1] !== isInitialValueLoading || $[2] !== revision ? (t0 = editState ? {
    ...editState,
    revision: revision || void 0,
    initialValueResolved: !isInitialValueLoading
  } : null, $[0] = editState, $[1] = isInitialValueLoading, $[2] = revision, $[3] = t0) : t0 = $[3];
  const actionProps = t0;
  let t1;
  $[4] !== actions ? (t1 = (actions ?? []).filter(isRestoreAction).slice(-1), $[4] = actions, $[5] = t1) : t1 = $[5];
  const historyActions = t1;
  let t2;
  $[6] !== connectionState || $[7] !== disabled ? (t2 = (t32) => {
    const {
      states
    } = t32;
    return (0, import_jsx_runtime2.jsx)(DocumentStatusBarActionsInner, { disabled: connectionState !== "connected" || !!disabled, states });
  }, $[6] = connectionState, $[7] = disabled, $[8] = t2) : t2 = $[8];
  const renderDocumentStatusBarActions = t2;
  if (!actionProps)
    return null;
  let t3;
  return $[9] !== actionProps || $[10] !== historyActions || $[11] !== renderDocumentStatusBarActions ? (t3 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions: historyActions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[9] = actionProps, $[10] = historyActions, $[11] = renderDocumentStatusBarActions, $[12] = t3) : t3 = $[12], t3;
});
...
function useChipScrollPosition(containerRef) {
  const $ = (0, import_react_compiler_runtime.c)(3), [showGradient, setShowGradient] = (0, import_react2.useState)(false);
  let t0, t1;
...
var DocumentPerspectiveList = (0, import_react2.memo)(function() {
  ...
  }, [displayed?._id, editState?.version, params?.historyVersion]), isPublishSelected = (0, import_react2.useMemo)(() => !!(isLiveEdit && !editState?.draft?._id && !selectedReleaseId || isPublishedId(displayed?._id || "") && isPublishedPerspective(selectedPerspectiveName || "")), [displayed?._id, editState?.draft?._id, isLiveEdit, selectedPerspectiveName, selectedReleaseId]), isDraftSelected = (0, import_react2.useMemo)(() => {
    const displayedId = displayed?._id || "";
    return isPublishSelected || params?.historyVersion || selectedPerspectiveName || isVersionId(displayedId) ? false : isDraftId(displayedId) ? true : !(isPublishedId(displayedId) && editState?.published && isPublishedPerspective(selectedPerspectiveName || ""));
  }, [displayed?._id, editState?.published, isPublishSelected, params?.historyVersion, selectedPerspectiveName]), isDraftDisabled = (0, import_react2.useMemo)(() => onlyHasVersions || isCreatingDocument && selectedReleaseId ? true : !editState?.draft && !isLiveEdit ? false : !!(isCreatingDocument && selectedReleaseId || isLiveEdit), [editState?.draft, isCreatingDocument, isLiveEdit, onlyHasVersions, selectedReleaseId]), isDraftModelEnabled = workspace.document.drafts?.enabled;
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: editState?.published && editState?.published?._updatedAt ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.published-date", values: {
...
var DocumentPanelHeader = (0, import_react2.memo)((0, import_react2.forwardRef)(function(_props, ref) {
  ...
  return (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: collapsed ? (0, import_jsx_runtime2.jsx)(PaneHeader$1, { border: true, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : (0, import_jsx_runtime2.jsx)(Card, { hidden: collapsed, style: {
    lineHeight: 0
...
var Timeline = ({
  ...
  const [mounted, setMounted] = (0, import_react2.useState)(false), {
    t: t2
  } = useTranslation("studio"), selectedChunkId = selectedChunk?.id, chunksWithMetadata = (0, import_react2.useMemo)(() => addChunksMetadata(chunks), [chunks]), [expandedParents, setExpandedParents] = (0, import_react2.useState)(() => {
    if (selectedChunkId) {
...
var FallbackStatus = () => {
  const {
    ...
    selectedPerspective
  } = usePerspective(), status = (0, import_react2.useMemo)(() => isPublishedPerspective(selectedPerspective) && editState?.published?._updatedAt ? {
...
var DocumentActionShortcuts = (0, import_react2.memo)((props) => {
  ...
  let t2;
  $[6] !== editState || $[7] !== isInitialValueLoading || $[8] !== revisionId ? (t2 = editState && {
    ...editState,
    onComplete: _temp$e,
    revision: revisionId || void 0,
    initialValueResolved: !isInitialValueLoading
  }, $[6] = editState, $[7] = isInitialValueLoading, $[8] = revisionId, $[9] = t2) : t2 = $[9];
  const actionProps = t2;
  let t3;
  $[10] !== actionsBoxElement || $[11] !== activeIndex || $[12] !== as || $[13] !== children || $[14] !== rest ? (t3 = (t42) => {
    const {
      states
    } = t42;
  ...
  }, $[10] = actionsBoxElement, $[11] = activeIndex, $[12] = as, $[13] = children, $[14] = rest, $[15] = t3) : t3 = $[15];
  const renderDocumentActionShortcuts = t3;
  if (!actionProps || !actions)
    return null;
  let t4;
  return $[16] !== actionProps || $[17] !== actions || $[18] !== renderDocumentActionShortcuts ? (t4 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actionProps, actions, children: renderDocumentActionShortcuts }), $[16] = actionProps, $[17] = actions, $[18] = renderDocumentActionShortcuts, $[19] = t4) : t4 = $[19], t4;
});
...
function DocumentLayout() {
  ...
  return schemaType ? (0, import_jsx_runtime2.jsxs)(GetFormValueProvider, { value, children: [
    ...
    fieldActions.length > 0 && schemaType && (0, import_jsx_runtime2.jsx)(FieldActionsResolver, { actions: fieldActions, documentId, documentType, onActions: setRootFieldActionNodes, path: EMPTY_ARRAY$1, schemaType }),
...
var useDocumentLastRev = (documentId, documentType) => {
  const $ = (0, import_react_compiler_runtime.c)(11), historyStore = useHistoryStore(), [lastRevisionDocument, setLastRevisionDocument] = (0, import_react2.useState)(null), [loading, setLoading] = (0, import_react2.useState)(false);
  let t0;
...
function useDocumentPaneInspector({
  ...
  const currentInspector = (0, import_react2.useMemo)(() => inspectors2?.find((i) => i.name === inspectorName), [inspectors2, inspectorName]), historyInspector = (0, import_react2.useMemo)(() => inspectors2.find((i_0) => i_0.name === HISTORY_INSPECTOR_NAME), [inspectors2]), changesOpen = currentInspector?.name === HISTORY_INSPECTOR_NAME, closeInspector = (0, import_react2.useCallback)((closeInspectorName) => {
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(distinctUntilChanged(), debounceTime(500), switchMap((document2) => isSanityDocument2(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged(), catchError(_temp$c)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], useObservable(t3);
}
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  ...
  }), [isDeleting, setIsDeleting] = (0, import_react2.useState)(false), {
    lastRevisionDocument
  } = useDocumentLastRev(documentId, documentType), getIsDeleted = (0, import_react2.useCallback)((editState) => timelineReady ? !editState?.draft && !editState?.published && !editState?.version && !isPristine : false, [timelineReady, isPristine]), getComparisonValue = (0, import_react2.useCallback)((editState_0) => changesOpen ? sinceDocument || editState_0?.published : editState_0?.published || null, [changesOpen, sinceDocument]), schemaType = schema.get(documentType), getIsReadOnly = (0, import_react2.useCallback)((editState_1) => {
  ...
  const compareValue = (0, import_react2.useMemo)(() => getComparisonValue(editState_2), [editState_2, getComparisonValue]), isDeleted_1 = (0, import_react2.useMemo)(() => getIsDeleted(editState_2), [editState_2, getIsDeleted]), revisionNotFound = onOlderRevision && !revisionDocument, currentDisplayed = (0, import_react2.useMemo)(() => editState_2.version && isGoingToUnpublish(editState_2.version) ? editState_2.published : displayed, [editState_2.version, editState_2.published, displayed]), documentPane = (0, import_react2.useMemo)(() => ({
    actions,
    activeViewId,
    badges,
    changesOpen,
...
var DocumentEventsPane = (props) => {
  ...
  let t11;
  $[19] !== eventsStore.events ? (t11 = eventsStore.events.find(_temp$b)?.id || null, $[19] = eventsStore.events, $[20] = t11) : t11 = $[20];
  let t12;
...
function PaneRouterProvider(props) {
  ...
  let t1;
  $[5] !== createNextRouterState || $[6] !== navigate ? (t1 = (modifier_0) => {
  ...
  const setPayload = t3;
  let t4;
  $[15] !== modifyCurrentGroup || $[16] !== siblingIndex ? (t4 = (nextParams_0) => {
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-WZ2LZXKN.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-FHWPD4GW.js"))
};
var StructureToolPane = (0, import_react2.memo)(function(props) {
  ...
  let t2;
  $[4] !== PaneComponent || $[5] !== active || $[6] !== index || $[7] !== itemId || $[8] !== pane2 || $[9] !== paneKey || $[10] !== selected || $[11] !== t1 ? (t2 = (0, import_jsx_runtime2.jsx)(PaneComponent, { childItemId: t1, index, itemId, isActive: active, isSelected: selected, paneKey, pane: pane2 }), $[4] = PaneComponent, $[5] = active, $[6] = index, $[7] = itemId, $[8] = pane2, $[9] = paneKey, $[10] = selected, $[11] = t1, $[12] = t2) : t2 = $[12];
  let t3;
  $[13] !== t0 || $[14] !== t2 ? (t3 = (0, import_jsx_runtime2.jsx)(import_react2.Suspense, { fallback: t0, children: t2 }), $[13] = t0, $[14] = t2, $[15] = t3) : t3 = $[15];
  let t4;
  return $[16] !== groupIndex || $[17] !== index || $[18] !== params || $[19] !== payload || $[20] !== siblingIndex || $[21] !== t3 ? (t4 = (0, import_jsx_runtime2.jsx)(PaneRouterProvider, { flatIndex: index, index: groupIndex, params, payload, siblingIndex, children: t3 }), $[16] = groupIndex, $[17] = index, $[18] = params, $[19] = payload, $[20] = siblingIndex, $[21] = t3, $[22] = t4) : t4 = $[22], t4;
}, ({
  params: prevParams = {},
  ...
  $[38] !== crossDatasetReferences || $[39] !== datasetSubtitle || $[40] !== internalReferences.totalCount || $[41] !== normalizedDatasetNames.length || $[42] !== t2 || $[43] !== toast ? (t15 = crossDatasetReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
    ...
    (0, import_jsx_runtime2.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
      (0, import_jsx_runtime2.jsxs)(Table$1, { children: [
        ...
        (0, import_jsx_runtime2.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$7).map((t162, index) => {
          const {
            projectId,
            datasetName,
            documentId
...
function useReferringDocuments(documentId) {
  ...
  let t3;
  $[8] !== crossDatasetReferences?.references ? (t3 = () => Array.from(new Set(crossDatasetReferences?.references.map(_temp$6).filter(Boolean))).sort(), $[8] = crossDatasetReferences?.references, $[9] = t3) : t3 = $[9];
  let t4;
  $[10] !== t3 ? (t4 = t3(), $[10] = t3, $[11] = t4) : t4 = $[11];
  const projectIds = t4;
  let t5;
  $[12] !== crossDatasetReferences?.references ? (t5 = Array.from(new Set(crossDatasetReferences?.references.map(_temp2$2).filter(_temp3$1))).sort(), $[12] = crossDatasetReferences?.references, $[13] = t5) : t5 = $[13];
  const datasetNames = t5;
  let t6;
  $[14] !== crossDatasetReferences?.references ? (t6 = () => !!crossDatasetReferences?.references.some(_temp4$1), $[14] = crossDatasetReferences?.references, $[15] = t6) : t6 = $[15];
...
function PaneHeaderCreateButton(t0) {
  ...
  const [templatePermissions, isTemplatePermissionsLoading] = useTemplatePermissions(t22), nothingGranted = !isTemplatePermissionsLoading && templatePermissions?.length !== 0 && templatePermissions?.every(_temp$5);
  let t3;
  bb0: {
    ...
    let t42;
    $[6] !== templatePermissions ? (t42 = templatePermissions.reduce(_temp2$1, {}), $[6] = templatePermissions, $[7] = t42) : t42 = $[7], t3 = t42;
  }
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t22 || $[14] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(SanityDefaultPreview, { title: t22, subtitle: t5, media: _temp$4, layout }), $[12] = layout, $[13] = t22, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$4() {
...
var DocumentListPane = (0, import_react2.memo)(function(props) {
  ...
  }, [filter2, params]), showIcons = displayOptions?.showIcons !== false, {
    t: t2
  } = useTranslation(structureLocaleNamespace), {
    title
...
function ColumnsControl({
  ...
  return (0, import_jsx_runtime2.jsx)(MenuButton, { button: (0, import_jsx_runtime2.jsx)(Button2, { mode: "bleed", text: t2("sheet-list.edit-columns") }), id: "columns-control", menu: (0, import_jsx_runtime2.jsx)(Menu, { padding: 3, paddingTop: 4, style: {
    ...
    (0, import_jsx_runtime2.jsx)(Flex, { style: {
      ...
      maxHeight: 320,
      overflowY: "scroll"
    }, children: (0, import_jsx_runtime2.jsx)(Stack, { children: table.getAllLeafColumns().filter((column_1) => column_1.getCanHide()).map((column_2) => (0, import_jsx_runtime2.jsxs)(Flex, { marginY: 2, align: "center", children: [
      ...
      (0, import_jsx_runtime2.jsx)(Box, { flex: 1, paddingLeft: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)("label", { htmlFor: `col-visibility-${column_2.id}`, children: column_2.columnDef.header?.toString() }) }) })
    ] }, column_2.id)) }) }),
...
function PublishedEventMenu(t0) {
  ...
  const t10 = portalContext.elements?.[TIMELINE_MENU_PORTAL$1] ? TIMELINE_MENU_PORTAL$1 : true;
  let t11;
...
function EventsInspector({
  ...
  const {
    ...
    sinceRevision,
    getChangesList
  } = useEvents(), isComparingCurrent = !revision?.revisionId, changesList$ = (0, import_react2.useMemo)(() => getChangesList(), [getChangesList]), {
    diff,
    loading: diffLoading,
    error: diffError
    ...
    value,
    showFromValue: true
  }), [diff, documentId, isComparingCurrent, formState?.readOnly, schemaType, value]), [sinceEvent, toEvent] = (0, import_react2.useMemo)(() => events ? [events.find((e2) => e2.id === sinceRevision?.revisionId) || null, events.find((e_0) => e_0.id === revision?.revisionId) || events[0]] : [null, null], [events, revision?.revisionId, sinceRevision?.revisionId]), sinceEvents = (0, import_react2.useMemo)(() => toEvent ? events.slice(events.indexOf(toEvent) + 1).map((event) => "parentId" in toEvent && "parentId" in event && event.parentId === toEvent.parentId || "parentId" in event && toEvent.id === event.parentId ? {
    ...event,
    parentId: void 0
...
function DocumentNodePathBreadcrumbs(props) {
  ...
  return pathTitles?.length ? (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: pathTitles.map((t2, i) => (
    // oxlint-disable-next-line no-array-index-key
    (0, import_jsx_runtime2.jsxs)(import_react2.Fragment, { children: [
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-7PND5XB6.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-OPIFISCT.js.map
