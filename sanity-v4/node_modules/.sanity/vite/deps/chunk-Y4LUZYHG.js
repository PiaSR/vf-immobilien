...
import {
  ...
  usePortal,
  useToast
} from "./chunk-A3E26EYO.js";
import {
  require_dist
} from "./chunk-E7MCITYM.js";
import {
  require_jsx_runtime
} from "./chunk-5HOPWBX5.js";
import {
  require_react
} from "./chunk-B7ZBOBEL.js";
import {
  __commonJS,
  __toESM
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-7D6XWNYQ.js")
});
...
var VersionModeHeader = (t0) => {
  ...
  let t22;
  $[2] !== documentVersions ? (t22 = documentVersions.flatMap(_temp$F), $[2] = documentVersions, $[3] = t22) : t22 = $[3];
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), {
    data: releases
  } = useActiveReleases(), [patchChannel] = (0, import_react2.useState)(_temp$D);
  let t2;
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$C), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function RequestPermissionDialog(t0) {
  ...
  bb0: {
    ...
    if ($[2] !== client.observable || $[3] !== projectId) {
      let t42;
      $[5] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (roles) => roles.filter(_temp$A).find(_temp2$f) ? "editor" : adminRole, $[5] = t42) : t42 = $[5];
      let t52;
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  let t22;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$x), $[6] = t22) : t22 = $[6];
...
function OpenReleaseToEditBannerInner(t0) {
  ...
  if ($[9] !== activeReleases || $[10] !== documentVersions || $[11] !== tCore) {
    ...
    }), $[13] = documentVersions, $[14] = t52) : t52 = $[14];
    let t622;
...
var DiscardChangesAction = (t0) => {
  ...
  let t3;
  $[6] !== discardChanges || $[7] !== onComplete ? (t3 = () => {
    discardChanges.execute(), onComplete();
  }, $[6] = discardChanges, $[7] = onComplete, $[8] = t3) : t3 = $[8];
  ...
  const handle = t4;
  let t5;
  $[10] !== handleConfirm || $[11] !== isConfirmDialogOpen || $[12] !== onComplete || $[13] !== t2 ? (t5 = isConfirmDialogOpen && {
    type: "confirm",
    tone: "critical",
    onCancel: onComplete,
    onConfirm: handleConfirm,
    message: t2("action.discard-changes.confirm-dialog.confirm-discard-changes")
  }, $[10] = handleConfirm, $[11] = isConfirmDialogOpen, $[12] = onComplete, $[13] = t2, $[14] = t5) : t5 = $[14];
  const dialog = t5;
  let t6;
  $[15] !== currentUser || $[16] !== dialog || $[17] !== discardChanges.disabled || $[18] !== isPermissionsLoading || $[19] !== isPublished || $[20] !== liveEdit || $[21] !== permissions?.granted || $[22] !== published || $[23] !== t2 ? (t6 = () => !published || liveEdit || isPublished ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: true,
    ...
    onHandle: handle,
    dialog
  }, $[15] = currentUser, $[16] = dialog, $[17] = discardChanges.disabled, $[18] = isPermissionsLoading, $[19] = isPublished, $[20] = liveEdit, $[21] = permissions?.granted, $[22] = published, $[23] = t2, $[24] = t6) : t6 = $[24];
  let t7;
  return $[25] !== t6 ? (t7 = t6(), $[25] = t6, $[26] = t7) : t7 = $[26], t7;
};
...
var DuplicateAction = (t0) => {
  const $ = (0, import_react_compiler_runtime2.c)(30), {
    id,
    type,
    onComplete,
    release,
  ...
  let t22;
  $[4] !== documentStore.pair || $[5] !== duplicate || $[6] !== id || $[7] !== mapDocument || $[8] !== navigateIntent || $[9] !== onComplete || $[10] !== type ? (t22 = async () => {
    const dupeId = v4_default();
    setDuplicating(true);
    const duplicateSuccess = firstValueFrom(documentStore.pair.operationEvents(id, type).pipe(filter(_temp$u)));
  ...
  }, $[4] = documentStore.pair, $[5] = duplicate, $[6] = id, $[7] = mapDocument, $[8] = navigateIntent, $[9] = onComplete, $[10] = type, $[11] = t22) : t22 = $[11];
  const handle = t22;
  let t3;
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      let t42;
      $[12] !== t2 ? (t42 = t2("action.duplicate.label"), $[12] = t2, $[13] = t42) : t42 = $[13];
      let t52;
      $[14] !== currentUser ? (t52 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[14] = currentUser, $[15] = t52) : t52 = $[15];
      let t62;
      $[16] !== t42 || $[17] !== t52 ? (t62 = {
        icon: CopyIcon,
        disabled: true,
        label: t42,
        title: t52
      }, $[16] = t42, $[17] = t52, $[18] = t62) : t62 = $[18], t3 = t62;
      break bb0;
    }
    const t4 = isDuplicating || !!duplicate.disabled || isPermissionsLoading;
    let t5;
    $[19] !== isDuplicating || $[20] !== t2 ? (t5 = t2(isDuplicating ? "action.duplicate.running.label" : "action.duplicate.label"), $[19] = isDuplicating, $[20] = t2, $[21] = t5) : t5 = $[21];
    let t6;
    $[22] !== duplicate.disabled || $[23] !== t2 ? (t6 = duplicate.disabled ? t2(DISABLED_REASON_KEY$1[duplicate.disabled]) : "", $[22] = duplicate.disabled, $[23] = t2, $[24] = t6) : t6 = $[24];
    let t7;
    $[25] !== handle || $[26] !== t4 || $[27] !== t5 || $[28] !== t6 ? (t7 = {
      icon: CopyIcon,
      disabled: t4,
      label: t5,
      title: t6,
      onHandle: handle
    }, $[25] = handle, $[26] = t4, $[27] = t5, $[28] = t6, $[29] = t7) : t7 = $[29], t3 = t7;
  }
  return t3;
};
...
var UnpublishAction = (t0) => {
  ...
  $[3] !== onComplete ? (t22 = () => {
    setConfirmDialogOpen(false), onComplete();
  }, $[3] = onComplete, $[4] = t22) : t22 = $[4];
  const handleCancel = t22;
  let t3;
  $[5] !== onComplete || $[6] !== unpublish ? (t3 = () => {
    setConfirmDialogOpen(false), unpublish.execute(), onComplete();
  }, $[5] = onComplete, $[6] = unpublish, $[7] = t3) : t3 = $[7];
  const handleConfirm = t3;
  let t4;
  bb0: {
    if (isConfirmDialogOpen) {
      ...
      let t62;
      $[8] !== handleCancel || $[9] !== handleConfirm || $[10] !== t52 || $[11] !== type ? (t62 = (0, import_jsx_runtime2.jsx)(ConfirmDeleteDialogContainer, { id: t52, type, action: "unpublish", onCancel: handleCancel, onConfirm: handleConfirm }), $[8] = handleCancel, $[9] = handleConfirm, $[10] = t52, $[11] = type, $[12] = t62) : t62 = $[12];
      let t7;
      $[13] !== onComplete || $[14] !== t62 ? (t7 = {
        type: "dialog",
        onClose: onComplete,
        content: t62
      }, $[13] = onComplete, $[14] = t62, $[15] = t7) : t7 = $[15], t4 = t7;
      break bb0;
    }
    t4 = null;
  }
  const dialog = t4;
  let t5;
  $[16] !== currentUser || $[17] !== dialog || $[18] !== isDraft || $[19] !== isPermissionsLoading || $[20] !== liveEdit || $[21] !== permissions?.granted || $[22] !== release || $[23] !== t2 || $[24] !== unpublish.disabled ? (t5 = () => release || isDraft || liveEdit ? null : !isPermissionsLoading && !permissions?.granted ? {
    tone: "critical",
    icon: UnpublishIcon,
    label: "Unpublish",
    ...
    dialog
  }, $[16] = currentUser, $[17] = dialog, $[18] = isDraft, $[19] = isPermissionsLoading, $[20] = liveEdit, $[21] = permissions?.granted, $[22] = release, $[23] = t2, $[24] = unpublish.disabled, $[25] = t5) : t5 = $[25];
  let t6;
  return $[26] !== t5 ? (t6 = t5(), $[26] = t5, $[27] = t6) : t6 = $[27], t6;
};
...
var DocumentStatusBarActionsInner = (0, import_react2.memo)(function(props) {
  ...
  bb0: {
    ...
    $[6] !== firstActionState.shortcut ? (t32 = firstActionState.shortcut && (0, import_jsx_runtime2.jsx)(Hotkeys, { "data-testid": "document-status-bar-hotkeys", fontSize: 1, style: {
      marginTop: -4,
      marginBottom: -4
    }, keys: String(firstActionState.shortcut).split("+").map(_temp$t) }), $[6] = firstActionState.shortcut, $[7] = t32) : t32 = $[7];
    let t42;
...
var DocumentStatusBarActions = (0, import_react2.memo)(function() {
  ...
  let t1;
  $[2] !== t0 ? (t1 = t0.filter(_temp2$d), $[2] = t0, $[3] = t1) : t1 = $[3];
  const actions = t1;
  let t2;
...
var HistoryStatusBarActions = (0, import_react2.memo)(function() {
  ...
  let t0;
  $[0] !== editState?.draft || $[1] !== editState?.published ? (t0 = editState?.draft || editState?.published || {}, $[0] = editState?.draft, $[1] = editState?.published, $[2] = t0) : t0 = $[2];
  const disabled = t0._rev === revision;
  let t1;
  $[3] !== editState || $[4] !== isInitialValueLoading || $[5] !== revision ? (t1 = editState ? {
    ...editState,
    revision: revision || void 0,
    initialValueResolved: !isInitialValueLoading
  } : null, $[3] = editState, $[4] = isInitialValueLoading, $[5] = revision, $[6] = t1) : t1 = $[6];
  const actionProps = t1;
  let t2;
  $[7] !== actions ? (t2 = (actions ?? []).filter(isRestoreAction).slice(-1), $[7] = actions, $[8] = t2) : t2 = $[8];
  const historyActions = t2;
  let t3;
  $[9] !== connectionState || $[10] !== disabled ? (t3 = (t42) => {
    const {
      states
    } = t42;
    return (0, import_jsx_runtime2.jsx)(DocumentStatusBarActionsInner, { disabled: connectionState !== "connected" || !!disabled, states });
  }, $[9] = connectionState, $[10] = disabled, $[11] = t3) : t3 = $[11];
  const renderDocumentStatusBarActions = t3;
  if (!actionProps)
    return null;
  let t4;
  return $[12] !== actionProps || $[13] !== historyActions || $[14] !== renderDocumentStatusBarActions ? (t4 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions: historyActions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[12] = actionProps, $[13] = historyActions, $[14] = renderDocumentStatusBarActions, $[15] = t4) : t4 = $[15], t4;
});
...
var DocumentPanelHeader = (0, import_react2.memo)((0, import_react2.forwardRef)(function(_props, ref) {
  ...
  } = useFieldActions(), [referenceElement, setReferenceElement] = (0, import_react2.useState)(null), scrollContainerRef = (0, import_react2.useRef)(null), showGradient = useChipScrollPosition(scrollContainerRef);
  let t0;
  $[0] !== allActions ? (t0 = allActions ?? [], $[0] = allActions, $[1] = t0) : t0 = $[1];
  let t1;
  $[2] !== t0 ? (t1 = t0.filter(_temp$r), $[2] = t0, $[3] = t1) : t1 = $[3];
  const actions = t1;
  let t2;
  $[4] !== fieldActions || $[5] !== menuItemGroups || $[6] !== menuItems || $[7] !== onMenuAction ? (t2 = resolveMenuNodes({
    actionHandler: onMenuAction,
    fieldActions,
    menuItems,
    menuItemGroups
  }), $[4] = fieldActions, $[5] = menuItemGroups, $[6] = menuItems, $[7] = onMenuAction, $[8] = t2) : t2 = $[8];
  const menuNodes = t2;
  let t3;
  $[9] !== menuNodes ? (t3 = menuNodes.filter(isMenuNodeButton), $[9] = menuNodes, $[10] = t3) : t3 = $[10];
  const menuButtonNodes = t3;
  let t4;
  $[11] !== menuNodes ? (t4 = menuNodes.filter(isNotMenuNodeButton), $[11] = menuNodes, $[12] = t4) : t4 = $[12];
  const contextMenuNodes = t4, {
    collapsed,
    isLast
  ...
  let t52;
  $[13] !== contextMenuNodes || $[14] !== referenceElement ? (t52 = (t62) => {
    const {
      states
    } = t62;
  ...
  }, $[13] = contextMenuNodes, $[14] = referenceElement, $[15] = t52) : t52 = $[15];
  const renderPaneActions = t52;
  let t6;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t6 = (0, import_jsx_runtime2.jsx)(DocumentHeaderTitle, {}), $[16] = t6) : t6 = $[16];
  const title = t6;
  let t7;
  $[17] !== BackLink2 || $[18] !== showBackButton || $[19] !== t5 ? (t7 = showBackButton && (0, import_jsx_runtime2.jsx)(Button2, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t5("pane-header.back-button.text")
  } }), $[17] = BackLink2, $[18] = showBackButton, $[19] = t5, $[20] = t7) : t7 = $[20];
  const backButton = t7;
  let t8;
  $[21] !== schemaType || $[22] !== unstable_languageFilter ? (t8 = unstable_languageFilter.length > 0 && (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: unstable_languageFilter.map((LanguageFilterComponent, idx) => (0, import_jsx_runtime2.jsx)(LanguageFilterComponent, { schemaType }, `language-filter-${idx}`)) }), $[21] = schemaType, $[22] = unstable_languageFilter, $[23] = t8) : t8 = $[23];
  let t9;
  $[24] !== menuButtonNodes ? (t9 = menuButtonNodes.map(_temp2$c), $[24] = menuButtonNodes, $[25] = t9) : t9 = $[25];
  let t10;
  $[26] !== actions || $[27] !== editState || $[28] !== isInitialValueLoading || $[29] !== renderPaneActions ? (t10 = editState && (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions, actionProps: {
    ...editState,
    initialValueResolved: !isInitialValueLoading
  }, group: "paneActions", children: renderPaneActions }), $[26] = actions, $[27] = editState, $[28] = isInitialValueLoading, $[29] = renderPaneActions, $[30] = t10) : t10 = $[30];
  let t11;
  $[31] !== onPaneSplit || $[32] !== showSplitPaneButton || $[33] !== t5 ? (t11 = showSplitPaneButton && (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": t5("buttons.split-pane-button.aria-label"), icon: SplitVerticalIcon, mode: "bleed", onClick: onPaneSplit, tooltipProps: {
    content: t5("buttons.split-pane-button.tooltip")
  } }, "split-pane-button"), $[31] = onPaneSplit, $[32] = showSplitPaneButton, $[33] = t5, $[34] = t11) : t11 = $[34];
  let t12;
  $[35] !== onPaneClose || $[36] !== showSplitPaneCloseButton || $[37] !== t5 ? (t12 = showSplitPaneCloseButton && (0, import_jsx_runtime2.jsx)(Button2, { icon: CloseIcon, mode: "bleed", onClick: onPaneClose, tooltipProps: {
    content: t5("buttons.split-pane-close-button.title")
  } }, "close-view-button"), $[35] = onPaneClose, $[36] = showSplitPaneCloseButton, $[37] = t5, $[38] = t12) : t12 = $[38];
  let t13;
  $[39] !== BackLink2 || $[40] !== showPaneGroupCloseButton || $[41] !== t5 ? (t13 = showPaneGroupCloseButton && (0, import_jsx_runtime2.jsx)(Button2, { icon: CloseIcon, mode: "bleed", tooltipProps: {
    content: t5("buttons.split-pane-close-group-button.title")
  }, as: BackLink2 }, "close-view-button"), $[39] = BackLink2, $[40] = showPaneGroupCloseButton, $[41] = t5, $[42] = t13) : t13 = $[42];
  let t14;
  $[43] !== t10 || $[44] !== t11 || $[45] !== t12 || $[46] !== t13 || $[47] !== t8 || $[48] !== t9 ? (t14 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
    t8,
    t9,
    t10,
    t11,
    t12,
    t13
  ] }), $[43] = t10, $[44] = t11, $[45] = t12, $[46] = t13, $[47] = t8, $[48] = t9, $[49] = t14) : t14 = $[49];
  const renderedActions = t14;
  let t15;
  return $[50] !== backButton || $[51] !== collapsed || $[52] !== connectionState || $[53] !== editState?.draft || $[54] !== editState?.published || $[55] !== ref || $[56] !== renderedActions || $[57] !== showGradient || $[58] !== tabIndex ? (t15 = (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: collapsed ? (0, import_jsx_runtime2.jsx)(PaneHeader$1, { border: true, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabIndex, backButton }) : (0, import_jsx_runtime2.jsx)(Card, { hidden: collapsed, style: {
    lineHeight: 0
  ...
  ] }) }) }), $[50] = backButton, $[51] = collapsed, $[52] = connectionState, $[53] = editState?.draft, $[54] = editState?.published, $[55] = ref, $[56] = renderedActions, $[57] = showGradient, $[58] = tabIndex, $[59] = t15) : t15 = $[59], t15;
}));
...
function _temp$r(action) {
  return !isRestoreAction(action);
}
function _temp2$c(item) {
...
var DocumentBadgesInner = (0, import_react2.memo)(function(t0) {
  ...
  if (states.length === 0)
    return null;
  let t1;
  $[0] !== states ? (t1 = states.map(_temp$q), $[0] = states, $[1] = t1) : t1 = $[1];
  let t2;
...
function DocumentBadges() {
  const $ = (0, import_react_compiler_runtime2.c)(3), {
    badges,
    editState
  } = useDocumentPane(), renderDocumentBadges = _temp2$b;
  if (!editState || !badges)
    return null;
  let t0;
...
var TooltipContent = (t0) => {
  ...
  let t3;
  $[4] !== collaborators ? (t3 = collaborators.map(_temp$p), $[4] = collaborators, $[5] = t3) : t3 = $[5];
  let t4;
...
var TimelineStatus = () => {
  const $ = (0, import_react_compiler_runtime2.c)(8), {
    timelineStore
  } = useDocumentPane(), chunks = useTimelineSelector(timelineStore, _temp$n), loading = useTimelineSelector(timelineStore, _temp2$9), event = chunks?.[0];
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
...
function DocumentLayout() {
  ...
  let t23;
  $[74] !== rootFieldActionNodes || $[75] !== t222 ? (t23 = (0, import_jsx_runtime2.jsx)(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY$1, children: t222 }), $[74] = rootFieldActionNodes, $[75] = t222, $[76] = t23) : t23 = $[76];
  let t24;
...
function DocumentPaneProvider(props) {
  const $ = (0, import_react_compiler_runtime2.c)(203), {
    children,
    index,
    pane: pane2,
    paneKey,
  ...
  } = t1, telemetry = useTelemetry(), router2 = useRouter(), paneRouter = usePaneRouter(), setPaneParams = paneRouter.setParams, {
    push: pushToast
  } = useToast(), {
    options,
    menuItemGroups: t2,
    title: t3,
    views: t4
  } = pane2, menuItemGroups = t2 === void 0 ? DEFAULT_MENU_ITEM_GROUPS : t2, title = t3 === void 0 ? null : t3;
  let t5;
  $[0] !== t4 ? (t5 = t4 === void 0 ? [] : t4, $[0] = t4, $[1] = t5) : t5 = $[1];
  const viewsProp = t5, paneOptions = useUnique(options), documentIdRaw = paneOptions.id;
  let t6;
  $[2] !== documentIdRaw ? (t6 = getPublishedId(documentIdRaw), $[2] = documentIdRaw, $[3] = t6) : t6 = $[3];
  const documentId = t6, documentType = options.type, params = useUnique(paneRouter.params) || EMPTY_PARAMS$2, {
    buildStudioUrl
    ...
    enabled: isDraftModelEnabled
  } = t8, enhancedObjectDialogEnabled = beta?.form?.enhancedObjectDialog?.enabled;
  let t9;
  bb0: {
    if (forcedVersion) {
      t9 = forcedVersion;
    ...
    let t102;
    $[4] !== perspective.selectedPerspectiveName || $[5] !== perspective.selectedReleaseId ? (t102 = {
      selectedPerspectiveName: perspective.selectedPerspectiveName,
      selectedReleaseId: perspective.selectedReleaseId
    }, $[4] = perspective.selectedPerspectiveName, $[5] = perspective.selectedReleaseId, $[6] = t102) : t102 = $[6], t9 = t102;
  }
  const {
    selectedReleaseId,
    selectedPerspectiveName
  } = t9, diffViewRouter = useDiffViewRouter();
  let t10;
  $[7] !== documentId || $[8] !== documentType || $[9] !== paneOptions || $[10] !== params ? (t10 = {
    paneOptions,
    documentId,
    documentType,
    params
  }, $[7] = documentId, $[8] = documentType, $[9] = paneOptions, $[10] = params, $[11] = t10) : t10 = $[11];
  const initialValue = useDocumentPaneInitialValue(t10), isInitialValueLoading = initialValue.loading;
  let t11;
  $[12] !== documentId || $[13] !== documentType || $[14] !== params || $[15] !== setPaneParams ? (t11 = {
    documentId,
    documentType,
    params,
    setParams: setPaneParams
  }, $[12] = documentId, $[13] = documentType, $[14] = params, $[15] = setPaneParams, $[16] = t11) : t11 = $[16];
  const {
    changesOpen,
    currentInspector,
    inspectors: inspectors2,
    ...
    inspectOpen,
    handleLegacyInspectClose
  } = useDocumentPaneInspector(t11), [isDeleting, setIsDeleting] = (0, import_react2.useState)(false), {
    lastRevisionDocument
  } = useDocumentLastRev(documentId, documentType);
  let t12;
  $[17] !== isPristine || $[18] !== timelineReady ? (t12 = (editState) => timelineReady ? !editState?.draft && !editState?.published && !editState?.version && !isPristine : false, $[17] = isPristine, $[18] = timelineReady, $[19] = t12) : t12 = $[19];
  const getIsDeleted = t12;
  let t13;
  $[20] !== changesOpen || $[21] !== sinceDocument ? (t13 = (upstreamEditState) => {
    const upstream = selectUpstreamVersion(upstreamEditState);
    return changesOpen ? sinceDocument || upstream : upstream || null;
  }, $[20] = changesOpen, $[21] = sinceDocument, $[22] = t13) : t13 = $[22];
  const getComparisonValue = t13;
  let t14;
  $[23] !== documentType || $[24] !== schema ? (t14 = schema.get(documentType), $[23] = documentType, $[24] = schema, $[25] = t14) : t14 = $[25];
  const schemaType = t14;
  let t15;
  $[26] !== getIsDeleted || $[27] !== isDeleting || $[28] !== isDraftModelEnabled || $[29] !== params.rev || $[30] !== perspective.selectedPerspective || $[31] !== schemaType ? (t15 = (editState_0) => {
  ...
  }, $[26] = getIsDeleted, $[27] = isDeleting, $[28] = isDraftModelEnabled, $[29] = params.rev, $[30] = perspective.selectedPerspective, $[31] = schemaType, $[32] = t15) : t15 = $[32];
  const getIsReadOnly = t15;
  let t16;
  $[33] !== lastNonDeletedRevId || $[34] !== lastRevisionDocument || $[35] !== onOlderRevision || $[36] !== revisionDocument ? (t16 = (value) => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
  } : !value._createdAt && !value._updatedAt && lastNonDeletedRevId && lastRevisionDocument ? lastRevisionDocument : value, $[33] = lastNonDeletedRevId, $[34] = lastRevisionDocument, $[35] = onOlderRevision, $[36] = revisionDocument, $[37] = t16) : t16 = $[37];
  const getDisplayed = t16;
  let t17;
  $[38] !== params.path ? (t17 = params.path ? fromString(params.path) : EMPTY_ARRAY$B, $[38] = params.path, $[39] = t17) : t17 = $[39];
  const t18 = router2.stickyParams.displayInlineChanges === "true";
  let t19;
  $[40] !== changesOpen || $[41] !== documentId || $[42] !== documentType || $[43] !== getComparisonValue || $[44] !== getDisplayed || $[45] !== getIsReadOnly || $[46] !== initialValue || $[47] !== onFocusPath || $[48] !== selectedPerspectiveName || $[49] !== selectedReleaseId || $[50] !== t17 || $[51] !== t18 ? (t19 = {
    changesOpen,
    documentType,
    documentId,
    initialValue,
    ...
    selectedPerspectiveName,
    initialFocusPath: t17,
    readOnly: getIsReadOnly,
    onFocusPath,
    getFormDocumentValue: getDisplayed,
    displayInlineChanges: t18
  }, $[40] = changesOpen, $[41] = documentId, $[42] = documentType, $[43] = getComparisonValue, $[44] = getDisplayed, $[45] = getIsReadOnly, $[46] = initialValue, $[47] = onFocusPath, $[48] = selectedPerspectiveName, $[49] = selectedReleaseId, $[50] = t17, $[51] = t18, $[52] = t19) : t19 = $[52];
  const {
  ...
  let t21;
  $[53] !== t20 ? (t21 = t20 === void 0 ? [] : t20, $[53] = t20, $[54] = t21) : t21 = $[54];
  const releases = t21;
  let t22;
  $[55] !== draftsEnabled || $[56] !== params || $[57] !== releases || $[58] !== selectedPerspectiveName || $[59] !== selectedReleaseId || $[60] !== value_0 ? (t22 = getDocumentVersionType(params, selectedReleaseId, value_0, selectedPerspectiveName, draftsEnabled, releases), $[55] = draftsEnabled, $[56] = params, $[57] = releases, $[58] = selectedPerspectiveName, $[59] = selectedReleaseId, $[60] = value_0, $[61] = t22) : t22 = $[61];
  const actionsPerspective = t22;
  let t23;
  $[62] !== actionsPerspective || $[63] !== documentId || $[64] !== documentType || $[65] !== selectedReleaseId ? (t23 = {
    schemaType: documentType,
    documentId,
    versionType: actionsPerspective,
    releaseId: selectedReleaseId
  }, $[62] = actionsPerspective, $[63] = documentId, $[64] = documentType, $[65] = selectedReleaseId, $[66] = t23) : t23 = $[66];
  const documentActionsProps = t23;
  let t24;
  $[67] !== documentActions2 || $[68] !== documentActionsProps ? (t24 = documentActions2(documentActionsProps), $[67] = documentActions2, $[68] = documentActionsProps, $[69] = t24) : t24 = $[69];
  const actions = t24;
  let t25;
  $[70] !== enhancedObjectDialogEnabled || $[71] !== onPathOpen || $[72] !== params || $[73] !== setPaneParams ? (t25 = (path) => {
  ...
  }, $[70] = enhancedObjectDialogEnabled, $[71] = onPathOpen, $[72] = params, $[73] = setPaneParams, $[74] = t25) : t25 = $[74];
  const handlePathOpen = t25;
  let t26;
  $[75] !== documentBadges2 || $[76] !== documentId || $[77] !== documentType ? (t26 = documentBadges2({
    schemaType: documentType,
    documentId
  }), $[75] = documentBadges2, $[76] = documentId, $[77] = documentType, $[78] = t26) : t26 = $[78];
  const badges = t26;
  let t27;
  $[79] !== documentId || $[80] !== documentType || $[81] !== languageFilterResolver ? (t27 = languageFilterResolver({
    schemaType: documentType,
    documentId
  }), $[79] = documentId, $[80] = documentType, $[81] = languageFilterResolver, $[82] = t27) : t27 = $[82];
  ...
  let t282;
  $[83] !== documentId || $[84] !== documentType || $[85] !== fieldActionsResolver || $[86] !== schemaType ? (t282 = schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
  }) : [], $[83] = documentId, $[84] = documentType, $[85] = fieldActionsResolver, $[86] = schemaType, $[87] = t282) : t282 = $[87];
  const fieldActions = t282, ready = formReady && (!params.rev || timelineReady || !!timelineError);
  let t29;
  $[88] !== getDisplayed || $[89] !== value_0 ? (t29 = getDisplayed(value_0), $[88] = getDisplayed, $[89] = value_0, $[90] = t29) : t29 = $[90];
  const displayed = t29;
  let t30;
  $[91] !== displayed || $[92] !== documentId || $[93] !== editState_1 ? (t30 = {
    strict: true,
    displayed,
    documentId,
    editState: editState_1
  }, $[91] = displayed, $[92] = documentId, $[93] = editState_1, $[94] = t30) : t30 = $[94];
  const {
    previousId
  } = useDocumentIdStack(t30);
  let t31;
  $[95] !== params || $[96] !== setPaneParams ? (t31 = (newSince, newRev) => {
    setPaneParams({
      ...params,
      since: newSince,
      rev: newRev || void 0
    });
  }, $[95] = params, $[96] = setPaneParams, $[97] = t31) : t31 = $[97];
  const setTimelineRange = t31;
  let t32;
  $[98] !== paneRouter ? (t32 = () => paneRouter.closeCurrent(), $[98] = paneRouter, $[99] = t32) : t32 = $[99];
  const handlePaneClose = t32;
  let t33;
  $[100] !== paneRouter ? (t33 = () => paneRouter.duplicateCurrent(), $[100] = paneRouter, $[101] = t33) : t33 = $[101];
  const handlePaneSplit = t33;
  let t34;
  $[102] !== router2 || $[103] !== telemetry ? (t34 = () => {
  ...
  }, $[102] = router2, $[103] = telemetry, $[104] = t34) : t34 = $[104];
  const toggleInlineChanges = t34;
  let t35;
  $[105] !== buildStudioUrl || $[106] !== diffViewRouter || $[107] !== documentId || $[108] !== documentType || $[109] !== handleHistoryOpen || $[110] !== handleInspectorAction || $[111] !== previewUrl || $[112] !== previousId || $[113] !== pushToast || $[114] !== t28 || $[115] !== telemetry || $[116] !== toggleInlineChanges || $[117] !== value_0._id ? (t35 = async (item) => {
  ...
  }, $[105] = buildStudioUrl, $[106] = diffViewRouter, $[107] = documentId, $[108] = documentType, $[109] = handleHistoryOpen, $[110] = handleInspectorAction, $[111] = previewUrl, $[112] = previousId, $[113] = pushToast, $[114] = t28, $[115] = telemetry, $[116] = toggleInlineChanges, $[117] = value_0._id, $[118] = t35) : t35 = $[118];
  const handleMenuAction = t35;
  let t36, t37;
  $[119] !== documentId || $[120] !== documentType || $[121] !== onChange || $[122] !== schemaType || $[123] !== setDocumentMeta ? (t36 = () => {
    setDocumentMeta({
      documentId,
      documentType,
      schemaType,
  ...
  }, t37 = [documentId, documentType, schemaType, onChange, setDocumentMeta], $[119] = documentId, $[120] = documentType, $[121] = onChange, $[122] = schemaType, $[123] = setDocumentMeta, $[124] = t36, $[125] = t37) : (t36 = $[124], t37 = $[125]), (0, import_react2.useEffect)(t36, t37);
  let t38;
  $[126] !== getComparisonValue || $[127] !== upstreamEditState_0 ? (t38 = getComparisonValue(upstreamEditState_0), $[126] = getComparisonValue, $[127] = upstreamEditState_0, $[128] = t38) : t38 = $[128];
  const compareValue = t38, isDeleted_1 = getIsDeleted(editState_1), revisionNotFound = onOlderRevision && !revisionDocument;
  let t39;
  bb1: {
  ...
  $[131] !== actions || $[132] !== activeViewId || $[133] !== badges || $[134] !== changesOpen || $[135] !== closeInspector || $[136] !== collapsedFieldSets || $[137] !== collapsedPaths || $[138] !== compareValue || $[139] !== connectionState || $[140] !== currentDisplayed || $[141] !== documentId || $[142] !== documentIdRaw || $[143] !== documentType || $[144] !== editState_1 || $[145] !== fieldActions || $[146] !== focusPath || $[147] !== formState || $[148] !== handleHistoryClose || $[149] !== handleHistoryOpen || $[150] !== handleLegacyInspectClose || $[151] !== handleMenuAction || $[152] !== handlePaneClose || $[153] !== handlePaneSplit || $[154] !== handlePathOpen || $[155] !== hasUpstreamVersion || $[156] !== index || $[157] !== inspectOpen || $[158] !== inspectors2 || $[159] !== isDeleted_1 || $[160] !== isDeleting || $[161] !== isInitialValueLoading || $[162] !== isPermissionsLoading || $[163] !== languageFilter || $[164] !== lastNonDeletedRevId || $[165] !== lastRevisionDocument || $[166] !== onBlur || $[167] !== onChange || $[168] !== onFocus || $[169] !== onSetActiveFieldGroup || $[170] !== onSetCollapsedFieldSet || $[171] !== onSetCollapsedPath || $[172] !== openInspector || $[173] !== openPath || $[174] !== paneKey || $[175] !== permissions || $[176] !== previewUrl || $[177] !== ready || $[178] !== revisionId || $[179] !== revisionNotFound || $[180] !== schemaType || $[181] !== selectedReleaseId || $[182] !== setTimelineRange || $[183] !== t40 || $[184] !== t41 || $[185] !== timelineError || $[186] !== timelineStore || $[187] !== title || $[188] !== validation || $[189] !== value_0 || $[190] !== views2 ? (t42 = {
    ...
    lastNonDeletedRevId,
    lastRevisionDocument
  }, $[131] = actions, $[132] = activeViewId, $[133] = badges, $[134] = changesOpen, $[135] = closeInspector, $[136] = collapsedFieldSets, $[137] = collapsedPaths, $[138] = compareValue, $[139] = connectionState, $[140] = currentDisplayed, $[141] = documentId, $[142] = documentIdRaw, $[143] = documentType, $[144] = editState_1, $[145] = fieldActions, $[146] = focusPath, $[147] = formState, $[148] = handleHistoryClose, $[149] = handleHistoryOpen, $[150] = handleLegacyInspectClose, $[151] = handleMenuAction, $[152] = handlePaneClose, $[153] = handlePaneSplit, $[154] = handlePathOpen, $[155] = hasUpstreamVersion, $[156] = index, $[157] = inspectOpen, $[158] = inspectors2, $[159] = isDeleted_1, $[160] = isDeleting, $[161] = isInitialValueLoading, $[162] = isPermissionsLoading, $[163] = languageFilter, $[164] = lastNonDeletedRevId, $[165] = lastRevisionDocument, $[166] = onBlur, $[167] = onChange, $[168] = onFocus, $[169] = onSetActiveFieldGroup, $[170] = onSetCollapsedFieldSet, $[171] = onSetCollapsedPath, $[172] = openInspector, $[173] = openPath, $[174] = paneKey, $[175] = permissions, $[176] = previewUrl, $[177] = ready, $[178] = revisionId, $[179] = revisionNotFound, $[180] = schemaType, $[181] = selectedReleaseId, $[182] = setTimelineRange, $[183] = t40, $[184] = t41, $[185] = timelineError, $[186] = timelineStore, $[187] = title, $[188] = validation, $[189] = value_0, $[190] = views2, $[191] = t42) : t42 = $[191];
  const documentPane = t42, pathRef = (0, import_react2.useRef)(void 0);
  let t43, t44;
  $[192] !== enhancedObjectDialogEnabled || $[193] !== formStateRef || $[194] !== onProgrammaticFocus || $[195] !== paneRouter || $[196] !== params || $[197] !== ready ? (t43 = () => {
  ...
  }, t44 = [formStateRef, onProgrammaticFocus, paneRouter, params, ready, enhancedObjectDialogEnabled], $[192] = enhancedObjectDialogEnabled, $[193] = formStateRef, $[194] = onProgrammaticFocus, $[195] = paneRouter, $[196] = params, $[197] = ready, $[198] = t43, $[199] = t44) : (t43 = $[198], t44 = $[199]), (0, import_react2.useEffect)(t43, t44);
  let t45;
  return $[200] !== children || $[201] !== documentPane ? (t45 = (0, import_jsx_runtime2.jsx)(DocumentPaneContext.Provider, { value: documentPane, children }), $[200] = children, $[201] = documentPane, $[202] = t45) : t45 = $[202], t45;
}
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-NDYJIDHG.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-E75KJAJP.js"))
};
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-FAB2CA3V.js")),
...
//# sourceMappingURL=chunk-Y4LUZYHG.js.map
