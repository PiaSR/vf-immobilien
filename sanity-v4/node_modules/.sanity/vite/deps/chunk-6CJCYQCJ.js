...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-VNU5NAZV.js")
});
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t32 = (t4) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t32) : t32 = $[7], t2 = syncChannel.pipe(distinctUntilChanged(_temp$q), filter(t32), map(_temp2$a)), $[3] = id, $[4] = syncChannel, $[5] = t2;
  } else
    t2 = $[5];
  const path = t2;
  let t3;
...
var DiffViewDocument = ({
  ...
  const compareValue = useCompareValue({
    compareDocument
  }), {
    data: releases
  } = useActiveReleases(), [patchChannel] = (0, import_react2.useState)(() => createPatchChannel()), perspective = (0, import_react2.useMemo)(() => findRelease(documentId, releases), [documentId, releases]), {
    formState,
    onChange,
    onFocus,
    onBlur,
  ...
  }), isLoading = formState === null || !ready, pathSyncChannel = usePathSyncChannel({
    id: role,
    syncChannel
  }), onPathOpen = (0, import_react2.useCallback)((path) => {
...
function PaneLayout(props) {
  ...
  const [controller] = (0, import_react2.useState)(_temp$p), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
function RequestPermissionDialog(t0) {
  ...
  bb0: {
    ...
    if ($[2] !== client.observable || $[3] !== projectId) {
      let t42;
      $[5] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (roles) => roles.filter(_temp$o).find(_temp2$9) ? "editor" : adminRole, $[5] = t42) : t42 = $[5];
      let t52;
...
function _temp2$9(role_0) {
  return role_0.name === "editor";
}
function _temp$o(role) {
...
function InsufficientPermissionBanner(t0) {
  ...
  const listFormat = useListFormat(t1), {
    t: t2
  } = useTranslation(structureLocaleNamespace), telemetry = useTelemetry(), roleTitles = currentUserRoles.map(_temp$n), roles = listFormat.formatToParts(roleTitles).map(_temp2$8);
  let t22;
  $[1] !== roles ? (t22 = {
...
function ArchivedReleaseDocumentBanner() {
  ...
  }, release = (0, import_react2.useMemo)(() => archivedReleases.find((r2) => getReleaseIdFromReleaseDocumentId(r2._id) === params?.historyVersion), [archivedReleases, params?.historyVersion]), description = (0, import_react2.useMemo)(() => release?.state === "published" ? "banners.published-release.description" : release && isCardinalityOneRelease(release) ? "banners.archived-scheduled-draft.description" : "banners.archived-release.description", [release]), title = release?.metadata.title || tCore("release.placeholder-untitled-release");
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  let t22;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$m), $[6] = t22) : t22 = $[6];
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  const $ = (0, import_react_compiler_runtime.c)(76), {
    hidden,
    margins
  } = props, {
    collapsedFieldSets,
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$l), isLocked = editState?.transactionSyncLock?.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0;
  ...
  $[40] !== collapsedFieldSets || $[41] !== collapsedPaths || $[42] !== compareValue || $[43] !== connectionState || $[44] !== documentId || $[45] !== editState?.draft || $[46] !== editState?.published || $[47] !== fieldActions || $[48] !== formState || $[49] !== hidden || $[50] !== isReadOnly || $[51] !== onBlur || $[52] !== onChange || $[53] !== onFocus || $[54] !== onPathOpen || $[55] !== onSetActiveFieldGroup || $[56] !== onSetCollapsedFieldSet || $[57] !== onSetCollapsedPath || $[58] !== openPath || $[59] !== patchChannel || $[60] !== presence || $[61] !== selectedPerspective || $[62] !== t2 || $[63] !== title || $[64] !== validation ? (t13 = connectionState === "connecting" && !editState?.draft && !editState?.published ? (0, import_jsx_runtime2.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
    ...
    (0, import_jsx_runtime2.jsx)(FormBuilder, { __internal_fieldActions: fieldActions, __internal_patchChannel: patchChannel, changed: formState.changed, collapsedFieldSets, collapsedPaths, compareValue: compareValue ?? void 0, focused: formState.focused, focusPath: formState.focusPath, groups: formState.groups, id: "root", members: formState.members, onChange, onFieldGroupSelect: onSetActiveFieldGroup, onPathBlur: onBlur, onPathFocus: onFocus, onPathOpen, onSetFieldSetCollapsed: onSetCollapsedFieldSet, onSetPathCollapsed: onSetCollapsedPath, openPath, perspective: selectedPerspective, presence, readOnly: isReadOnly, schemaType: formState.schemaType, validation, value: formState.value })
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = compareValue, $[43] = connectionState, $[44] = documentId, $[45] = editState?.draft, $[46] = editState?.published, $[47] = fieldActions, $[48] = formState, $[49] = hidden, $[50] = isReadOnly, $[51] = onBlur, $[52] = onChange, $[53] = onFocus, $[54] = onPathOpen, $[55] = onSetActiveFieldGroup, $[56] = onSetCollapsedFieldSet, $[57] = onSetCollapsedPath, $[58] = openPath, $[59] = patchChannel, $[60] = presence, $[61] = selectedPerspective, $[62] = t2, $[63] = title, $[64] = validation, $[65] = t13) : t13 = $[65];
  let t14;
  $[66] !== setRef || $[67] !== t12 || $[68] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t12, children: t13 }), $[66] = setRef, $[67] = t12, $[68] = t13, $[69] = t14) : t14 = $[69];
  let t15;
  $[70] !== margins || $[71] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(PresenceOverlay, { margins, children: t14 }), $[70] = margins, $[71] = t14, $[72] = t15) : t15 = $[72];
  let t16;
  return $[73] !== hidden || $[74] !== t15 ? (t16 = (0, import_jsx_runtime2.jsx)(Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[73] = hidden, $[74] = t15, $[75] = t16) : t16 = $[75], t16;
});
...
function ActionMenuListItem(props) {
  ...
  let t1;
  $[4] !== actionState.shortcut ? (t1 = actionState.shortcut ? String(actionState.shortcut).split("+").map(_temp$k) : void 0, $[4] = actionState.shortcut, $[5] = t1) : t1 = $[5];
...
var DocumentStatusBarActionsInner = (0, import_react2.memo)(function(props) {
  ...
  bb0: {
    ...
    $[6] !== firstActionState.shortcut ? (t32 = firstActionState.shortcut && (0, import_jsx_runtime2.jsx)(Hotkeys, { "data-testid": "document-status-bar-hotkeys", fontSize: 1, style: {
      marginTop: -4,
      marginBottom: -4
    }, keys: String(firstActionState.shortcut).split("+").map(_temp$j) }), $[6] = firstActionState.shortcut, $[7] = t32) : t32 = $[7];
    let t42;
...
var DocumentStatusBarActions = (0, import_react2.memo)(function() {
  ...
  let t1;
  $[2] !== t0 ? (t1 = t0.filter(_temp2$7), $[2] = t0, $[3] = t1) : t1 = $[3];
  const actions = t1;
  let t2;
...
var DocumentBadgesInner = (0, import_react2.memo)(function(t0) {
  ...
  if (states.length === 0)
    return null;
  let t1;
  $[0] !== states ? (t1 = states.map(_temp$i), $[0] = states, $[1] = t1) : t1 = $[1];
  let t2;
...
function DocumentBadges() {
  const $ = (0, import_react_compiler_runtime.c)(3), {
    badges,
    editState
  } = useDocumentPane(), renderDocumentBadges = _temp2$6;
  if (!editState || !badges)
    return null;
  let t0;
...
var TooltipContent = (t0) => {
  ...
  let t3;
  $[4] !== collaborators ? (t3 = collaborators.map(_temp$h), $[4] = collaborators, $[5] = t3) : t3 = $[5];
  let t4;
...
var TimelineStatus = () => {
  const $ = (0, import_react_compiler_runtime.c)(8), {
    timelineStore
  } = useDocumentPane(), chunks = useTimelineSelector(timelineStore, _temp$g), loading = useTimelineSelector(timelineStore, _temp2$5), event = chunks?.[0];
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
...
var useDocumentLastRev = (documentId, documentType) => {
  ...
  const timelineStore = useTimelineStore(t0), lastNonDeletedRevId = useTimelineSelector(timelineStore, _temp$e);
  let t1, t2;
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t3 = subject.asObservable().pipe(distinctUntilChanged(), debounceTime(500), switchMap((document2) => isSanityDocument2(document2) ? from(resolveProductionUrl({
    document: document2
  })) : of(void 0)), distinctUntilChanged(), catchError(_temp$d)), $[4] = resolveProductionUrl, $[5] = t3) : t3 = $[5], useObservable(t3);
}
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  const {
    ...
    lastRevisionDocument
  } = useDocumentLastRev(documentId, documentType), getIsDeleted = (0, import_react2.useCallback)((editState) => timelineReady ? !editState?.draft && !editState?.published && !editState?.version && !isPristine : false, [timelineReady, isPristine]), getComparisonValue = (0, import_react2.useCallback)((upstreamEditState) => {
  ...
  }, [changesOpen, sinceDocument]), schemaType = schema.get(documentType), getIsReadOnly = (0, import_react2.useCallback)((editState_0) => {
    ...
    data: releases = []
  } = useActiveReleases(), getDocumentVersionType = (0, import_react2.useCallback)(() => {
    let version;
    switch (true) {
      case !!params.rev:
        version = "revision";
    ...
    return version;
  }, [params.rev, selectedReleaseId, value_0._id, selectedPerspectiveName, draftsEnabled, releases]), actionsPerspective = (0, import_react2.useMemo)(() => getDocumentVersionType(), [getDocumentVersionType]), documentActionsProps = (0, import_react2.useMemo)(() => ({
    schemaType: documentType,
    documentId,
  ...
  const compareValue = (0, import_react2.useMemo)(() => getComparisonValue(upstreamEditState_0), [upstreamEditState_0, getComparisonValue]), isDeleted_1 = (0, import_react2.useMemo)(() => getIsDeleted(editState_1), [editState_1, getIsDeleted]), revisionNotFound = onOlderRevision && !revisionDocument, currentDisplayed = (0, import_react2.useMemo)(() => editState_1.version && isGoingToUnpublish(editState_1.version) ? editState_1.published : displayed, [editState_1.version, editState_1.published, displayed]), documentPane = (0, import_react2.useMemo)(() => ({
    actions,
    activeViewId,
    badges,
    changesOpen,
...
var DocumentEventsPane = (props) => {
  ...
  let t11;
  $[19] !== eventsStore.events ? (t11 = eventsStore.events.find(_temp$c)?.id || null, $[19] = eventsStore.events, $[20] = t11) : t11 = $[20];
  let t12;
...
var DocumentPerspectiveResetHandler = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(13), {
    documentId
  } = t0, rawContext = (0, import_react2.useContext)(RawPerspectiveContext);
  let t1;
  $[0] !== documentId ? (t1 = {
    documentId
  }, $[0] = documentId, $[1] = t1) : t1 = $[1];
  ...
  } = useDocumentVersions(t1), setPerspective = useSetPerspective();
  let t2;
  $[2] !== documentVersions || $[3] !== documentVersionsLoading || $[4] !== rawContext || $[5] !== setPerspective ? (t2 = () => {
    if (!(documentVersionsLoading || !rawContext || !isCardinalityOnePerspective(rawContext.selectedPerspective))) {
      if (!documentVersions?.length) {
        setPerspective(void 0);
        return;
      }
      documentVersions.map(_temp$a).includes(rawContext.selectedReleaseId) || setPerspective(void 0);
    }
  }, $[2] = documentVersions, $[3] = documentVersionsLoading, $[4] = rawContext, $[5] = setPerspective, $[6] = t2) : t2 = $[6];
  let t3;
  return $[7] !== documentId || $[8] !== documentVersions || $[9] !== documentVersionsLoading || $[10] !== rawContext || $[11] !== setPerspective ? (t3 = [documentId, rawContext, documentVersions, documentVersionsLoading, setPerspective], $[7] = documentId, $[8] = documentVersions, $[9] = documentVersionsLoading, $[10] = rawContext, $[11] = setPerspective, $[12] = t3) : t3 = $[12], (0, import_react2.useEffect)(t2, t3), null;
};
function DocumentPerspectiveProvider(t0) {
  const $ = (0, import_react_compiler_runtime.c)(21), {
    children,
    documentId
  } = t0, rawContext = (0, import_react2.useContext)(RawPerspectiveContext), mappedContext = (0, import_react2.useContext)(PerspectiveContext);
  let t1;
  $[0] !== documentId ? (t1 = {
    documentId
  }, $[0] = documentId, $[1] = t1) : t1 = $[1];
  const {
    ...
    enabled: isDraftModelEnabled
  } = t3, defaultPerspective = isDraftModelEnabled ? LATEST : PUBLISHED$1;
  let t4;
  bb0: {
    if (!rawContext || !mappedContext) {
      t4 = mappedContext;
      break bb0;
    }
    ...
    if (documentVersionsLoading || !documentVersions?.length) {
      let t53;
      $[2] !== defaultPerspective || $[3] !== mappedContext ? (t53 = {
        ...mappedContext,
        selectedPerspective: defaultPerspective,
        selectedPerspectiveName: void 0,
        selectedReleaseId: void 0
      }, $[2] = defaultPerspective, $[3] = mappedContext, $[4] = t53) : t53 = $[4], t4 = t53;
      break bb0;
    }
    if (!documentVersions.map(_temp2$3).includes(rawContext.selectedReleaseId)) {
      let t53;
      $[5] !== defaultPerspective || $[6] !== mappedContext ? (t53 = {
        ...mappedContext,
        selectedPerspective: defaultPerspective,
        selectedPerspectiveName: void 0,
        selectedReleaseId: void 0
      }, $[5] = defaultPerspective, $[6] = mappedContext, $[7] = t53) : t53 = $[7], t4 = t53;
      break bb0;
    }
    let t52;
    $[8] !== mappedContext || $[9] !== rawContext.selectedPerspective || $[10] !== rawContext.selectedPerspectiveName || $[11] !== rawContext.selectedReleaseId ? (t52 = {
      ...mappedContext,
    ...
    }, $[8] = mappedContext, $[9] = rawContext.selectedPerspective, $[10] = rawContext.selectedPerspectiveName, $[11] = rawContext.selectedReleaseId, $[12] = t52) : t52 = $[12], t4 = t52;
  }
  const value = t4;
  if (!value) {
    let t52;
  ...
  let t5;
  $[15] !== documentId ? (t5 = (0, import_jsx_runtime2.jsx)(DocumentPerspectiveResetHandler, { documentId }), $[15] = documentId, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== children || $[18] !== t5 || $[19] !== value ? (t6 = (0, import_jsx_runtime2.jsxs)(PerspectiveContext.Provider, { value, children: [
    children,
    t5
  ] }), $[17] = children, $[18] = t5, $[19] = value, $[20] = t6) : t6 = $[20], t6;
}
...
var DocumentPaneProviderWrapper = (0, import_react2.memo)((props) => {
  const $ = (0, import_react_compiler_runtime.c)(8), source = useSource();
  let t0;
  $[0] !== props.itemId ? (t0 = getPublishedId(props.itemId), $[0] = props.itemId, $[1] = t0) : t0 = $[1];
  const documentId = t0;
  let t1;
  $[2] !== props || $[3] !== source.beta?.eventsAPI?.documents ? (t1 = source.beta?.eventsAPI?.documents ? (0, import_jsx_runtime2.jsx)(DocumentEventsPane, { ...props }) : (0, import_jsx_runtime2.jsx)(DocumentPaneWithLegacyTimelineStore, { ...props }), $[2] = props, $[3] = source.beta?.eventsAPI?.documents, $[4] = t1) : t1 = $[4];
  let t2;
  return $[5] !== documentId || $[6] !== t1 ? (t2 = (0, import_jsx_runtime2.jsx)(DocumentPerspectiveProvider, { documentId, children: t1 }), $[5] = documentId, $[6] = t1, $[7] = t2) : t2 = $[7], t2;
});
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-RJL7CIIF.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-3PBV5ZYU.js"))
};
...
function EventsTimelineMenu({
  ...
  const selectRev = (0, import_react2.useCallback)((revEvent) => {
    ...
    timestamp: new Date(event.timestamp),
    formatParams
  }) : events.length > 0 ? t2("timeline.since-version-missing") : t2("timeline.no-previous-events"), buttonLabel = mode === "rev" ? revLabel : sinceLabel, portalElements = (0, import_react2.useMemo)(() => ({
...
function EventsInspector({
  ...
  return events.length ? (0, import_jsx_runtime2.jsxs)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    (0, import_jsx_runtime2.jsxs)(Box, { padding: 3, style: {
      ...
      (0, import_jsx_runtime2.jsxs)(Grid, { paddingX: 2, paddingBottom: 2, children: [
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-MWS6NJFL.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-6CJCYQCJ.js.map
